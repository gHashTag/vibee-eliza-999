...
interface DeleteKmsKeyOptions {
    keyId: string;
}
interface DeleteKmsKeyResponse {
    key: KmsKey;
}
interface GetKmsKeyByNameOptions {
    projectId: string;
    name: string;
}
...
interface KmsEncryptDataOptions {
    keyId: string;
    plaintext: string;
}
interface KmsEncryptDataResponse {
    ciphertext: string;
}
interface KmsDecryptDataOptions {
    keyId: string;
    ciphertext: string;
}
interface KmsDecryptDataResponse {
    plaintext: string;
}
interface KmsSignDataOptions {
    keyId: string;
    data: string;
    signingAlgorithm: SigningAlgorithm;
    isDigest?: boolean;
}
interface KmsSignDataResponse {
    signature: string;
    keyId: string;
    signingAlgorithm: SigningAlgorithm;
}
interface KmsVerifyDataOptions {
    keyId: string;
    data: string;
    signature: string;
    signingAlgorithm: SigningAlgorithm;
...
interface KmsVerifyDataResponse {
    signatureValid: boolean;
    keyId: string;
    signingAlgorithm: SigningAlgorithm;
}
interface KmsListSigningAlgorithmsOptions {
    keyId: string;
}
interface KmsListSigningAlgorithmsResponse {
    signingAlgorithms: SigningAlgorithm[];
}
interface KmsGetPublicKeyOptions {
    keyId: string;
}
...
declare class KmsApi {
    private apiClient;
    constructor(apiClient: ApiClient);
    createKmsKey(data: CreateKmsKeyOptions): Promise<CreateKmsKeyResponse>;
    deleteKmsKey(data: DeleteKmsKeyOptions): Promise<DeleteKmsKeyResponse>;
    getKmsKeyByName(data: GetKmsKeyByNameOptions): Promise<GetKmsKeyByNameResponse>;
    encryptData(data: KmsEncryptDataOptions): Promise<KmsEncryptDataResponse>;
    decryptData(data: KmsDecryptDataOptions): Promise<KmsDecryptDataResponse>;
    signData(data: KmsSignDataOptions): Promise<KmsSignDataResponse>;
    verifyData(data: KmsVerifyDataOptions): Promise<KmsVerifyDataResponse>;
    listSigningAlgorithms(data: KmsListSigningAlgorithmsOptions): Promise<KmsListSigningAlgorithmsResponse>;
    getSigningPublicKey(data: KmsGetPublicKeyOptions): Promise<KmsGetPublicKeyResponse>;
}

declare class KmsClient {
    private apiClient;
    constructor(apiClient: KmsApi);
    keys: () => {
        create: (options: CreateKmsKeyOptions) => Promise<KmsKey>;
        delete: (options: DeleteKmsKeyOptions) => Promise<KmsKey>;
        getByName: (options: GetKmsKeyByNameOptions) => Promise<KmsKey>;
    };
    encryption: () => {
        encrypt: (options: KmsEncryptDataOptions) => Promise<string>;
        decrypt: (options: KmsDecryptDataOptions) => Promise<string>;
    };
    signing: () => {
        sign: (options: KmsSignDataOptions) => Promise<KmsSignDataResponse>;
        verify: (options: KmsVerifyDataOptions) => Promise<KmsVerifyDataResponse>;
        listSigningAlgorithms: (options: KmsListSigningAlgorithmsOptions) => Promise<SigningAlgorithm[]>;
        getPublicKey: (options: KmsGetPublicKeyOptions) => Promise<string>;
    };
}
...
export { type ApiResponse, type AwsIamAuthLoginRequest, type AwsIamAuthLoginResponse, type BaseSecretOptions, type CreateDynamicSecretLeaseOptions, type CreateDynamicSecretOptions, type CreateDynamicSecretRequest, type CreateDynamicSecretResponse, type CreateEnvironmentOptions, type CreateEnvironmentRequest, type CreateEnvironmentResponse, type CreateFolderOptions, type CreateFolderRequest, type CreateFolderResponse, type CreateKmsKeyOptions, type CreateKmsKeyResponse, type CreateLeaseRequest, type CreateLeaseResponse, type CreateProjectOptions, type CreateProjectRequest, type CreateProjectResponse, type CreateSecretOptions, type CreateSecretRequest, type CreateSecretResponse, type DeleteDynamicSecretLeaseOptions, type DeleteDynamicSecretOptions, type DeleteDynamicSecretRequest, type DeleteDynamicSecretResponse, type DeleteKmsKeyOptions, type DeleteKmsKeyResponse, type DeleteLeaseRequest, type DeleteLeaseResponse, type DeleteSecretOptions, type DeleteSecretRequest, type DeleteSecretResponse, type DynamicSecret, DynamicSecretProviders, EncryptionAlgorithm, type Environment, type Folder, type GetKmsKeyByNameOptions, type GetKmsKeyByNameResponse, type GetSecretOptions, type GetSecretRequest, type GetSecretResponse, InfisicalSDK, type InviteMemberToProjectOptions, type InviteMembersRequest, type InviteMembersResponse, KeyUsage, type KmsDecryptDataOptions, type KmsDecryptDataResponse, type KmsEncryptDataOptions, type KmsEncryptDataResponse, type KmsGetPublicKeyOptions, type KmsGetPublicKeyResponse, type KmsKey, type KmsListSigningAlgorithmsOptions, type KmsListSigningAlgorithmsResponse, type KmsSignDataOptions, type KmsSignDataResponse, type KmsVerifyDataOptions, type KmsVerifyDataResponse, type Lease, type ListFoldersOptions, type ListFoldersRequest, type ListFoldersResponse, type ListSecretsOptions, type ListSecretsRequest, type ListSecretsResponse, type Membership, type Project, type RenewDynamicSecretLeaseOptions, type RenewLeaseRequest, type RenewLeaseResponse, type Secret, SecretType, SigningAlgorithm, SqlProviders, type TDynamicSecretProvider, type TokenRenewRequest, type TokenRenewResponse, type UniversalAuthLoginRequest, type UniversalAuthLoginResponse, type UpdateSecretOptions, type UpdateSecretRequest, type UpdateSecretResponse };
