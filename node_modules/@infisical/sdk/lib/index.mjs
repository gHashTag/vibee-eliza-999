...
var KmsApi = class {
  ...
  createKmsKey(data) {
    return __async(this, null, function* () {
      return this.apiClient.post("/api/v1/kms/keys", data);
    });
  }
  deleteKmsKey(data) {
    return __async(this, null, function* () {
      return this.apiClient.delete(`/api/v1/kms/keys/${data.keyId}`);
    });
  }
  getKmsKeyByName(data) {
    return __async(this, null, function* () {
      return this.apiClient.get(`/api/v1/kms/keys/key-name/${encodeURIComponent(data.name)}?projectId=${data.projectId}`);
    });
  }
  encryptData(data) {
    return __async(this, null, function* () {
      return this.apiClient.post(`/api/v1/kms/keys/${data.keyId}/encrypt`, data);
    });
  }
  decryptData(data) {
    return __async(this, null, function* () {
      return this.apiClient.post(`/api/v1/kms/keys/${data.keyId}/decrypt`, data);
    });
  }
  signData(data) {
    return __async(this, null, function* () {
      return this.apiClient.post(`/api/v1/kms/keys/${data.keyId}/sign`, data);
    });
  }
  verifyData(data) {
    return __async(this, null, function* () {
      return this.apiClient.post(`/api/v1/kms/keys/${data.keyId}/verify`, data);
    });
  }
  listSigningAlgorithms(data) {
    return __async(this, null, function* () {
      return this.apiClient.get(`/api/v1/kms/keys/${data.keyId}/signing-algorithms`);
    });
  }
  getSigningPublicKey(data) {
    return __async(this, null, function* () {
      return this.apiClient.get(`/api/v1/kms/keys/${data.keyId}/public-key`);
    });
  }
};
...
var KmsClient = class {
  constructor(apiClient) {
    this.apiClient = apiClient;
    this.keys = () => {
      const create = (options) => __async(this, null, function* () {
        try {
          const res = yield this.apiClient.createKmsKey(options);
          return res.key;
        } catch (err) {
          throw newInfisicalError(err);
        }
      });
      const deleteKmsKey = (options) => __async(this, null, function* () {
        try {
          const res = yield this.apiClient.deleteKmsKey(options);
          return res.key;
        } catch (err) {
          throw newInfisicalError(err);
        }
      });
      const getByName = (options) => __async(this, null, function* () {
        try {
          const res = yield this.apiClient.getKmsKeyByName(options);
          return res.key;
        } catch (err) {
          throw newInfisicalError(err);
        }
    ...
    this.encryption = () => {
      const encrypt = (options) => __async(this, null, function* () {
        try {
          const res = yield this.apiClient.encryptData(options);
          return res.ciphertext;
        } catch (err) {
          throw newInfisicalError(err);
        }
      });
      const decrypt = (options) => __async(this, null, function* () {
        try {
          const res = yield this.apiClient.decryptData(options);
    ...
    this.signing = () => {
      const sign = (options) => __async(this, null, function* () {
        try {
          const res = yield this.apiClient.signData(options);
          return res;
        } catch (err) {
          throw newInfisicalError(err);
        }
      });
      const verify = (options) => __async(this, null, function* () {
        try {
          const res = yield this.apiClient.verifyData(options);
          return res;
        } catch (err) {
          throw newInfisicalError(err);
        }
      });
      const listSigningAlgorithms = (options) => __async(this, null, function* () {
        try {
          const res = yield this.apiClient.listSigningAlgorithms(options);
          return res.signingAlgorithms;
        } catch (err) {
          throw newInfisicalError(err);
        }
      });
      const getPublicKey = (options) => __async(this, null, function* () {
        try {
          const res = yield this.apiClient.getSigningPublicKey(options);
...
var EncryptionAlgorithm = /* @__PURE__ */ ((EncryptionAlgorithm2) => {
  EncryptionAlgorithm2["RSA_4096"] = "RSA_4096";
  EncryptionAlgorithm2["ECC_NIST_P256"] = "ECC_NIST_P256";
  EncryptionAlgorithm2["AES_256_GCM"] = "aes-256-gcm";
  EncryptionAlgorithm2["AES_128_GCM"] = "aes-128-gcm";
  return EncryptionAlgorithm2;
})(EncryptionAlgorithm || {});
var SigningAlgorithm = /* @__PURE__ */ ((SigningAlgorithm2) => {
  SigningAlgorithm2["RSASSA_PSS_SHA_512"] = "RSASSA_PSS_SHA_512";
  SigningAlgorithm2["RSASSA_PSS_SHA_384"] = "RSASSA_PSS_SHA_384";
  SigningAlgorithm2["RSASSA_PSS_SHA_256"] = "RSASSA_PSS_SHA_256";
  SigningAlgorithm2["RSASSA_PKCS1_V1_5_SHA_512"] = "RSASSA_PKCS1_V1_5_SHA_512";
  SigningAlgorithm2["RSASSA_PKCS1_V1_5_SHA_384"] = "RSASSA_PKCS1_V1_5_SHA_384";
  SigningAlgorithm2["RSASSA_PKCS1_V1_5_SHA_256"] = "RSASSA_PKCS1_V1_5_SHA_256";
  SigningAlgorithm2["ECDSA_SHA_512"] = "ECDSA_SHA_512";
  SigningAlgorithm2["ECDSA_SHA_384"] = "ECDSA_SHA_384";
  SigningAlgorithm2["ECDSA_SHA_256"] = "ECDSA_SHA_256";
  return SigningAlgorithm2;
})(SigningAlgorithm || {});
var KeyUsage = /* @__PURE__ */ ((KeyUsage2) => {
  KeyUsage2["ENCRYPTION"] = "encrypt-decrypt";
  KeyUsage2["SIGNING"] = "sign-verify";
  return KeyUsage2;
})(KeyUsage || {});
