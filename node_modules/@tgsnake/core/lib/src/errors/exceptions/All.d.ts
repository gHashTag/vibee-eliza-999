...
declare const Exceptions: {
    ...
    400: {
        ...
        BOT_ALREADY_DISABLED: string;
        BOT_APP_BOT_INVALID: string;
        BOT_APP_INVALID: string;
        BOT_APP_SHORTNAME_INVALID: string;
        BOT_BUSINESS_MISSING: string;
        ...
        BUSINESS_WORK_HOURS_EMPTY: string;
        BUSINESS_WORK_HOURS_PERIOD_INVALID: string;
        ...
        IMPORT_FORMAT_DATE_INVALID: string;
        IMPORT_FORMAT_UNRECOGNIZED: string;
        IMPORT_HISTORY_LOG_EMPTY: string;
        ...
        STICKERSET_NOT_MODIFIED: string;
        ...
        TRANSLATE_REQ_QUOTA_EXCEEDED: string;
    ...
    403: {
        ...
        CHAT_SEND_ROUNDVIDEOS_FORBIDDEN: string;
        ...
        VOICE_MESSAGES_FORBIDDEN: string;
        YOUR_PRIVACY_RESTRICTED: string;
    };
    404: {
        _: string;
        PEER_ID_INVALID: string;
    ...
    500: {
        ...
        AUTH_RESTART: string;
        AUTH_RESTART_X: string;
        CALL_OCCUPY_FAILED: string;
        CDN_SALTS_EMPTY: string;
