...
export declare class AuthKeyUnsynchronized extends InternalServerError {
    id: string;
    message: string;
}
...
export declare class AuthRestartX extends InternalServerError {
    id: string;
    message: string;
}
...
export declare class CdnSaltsEmpty extends InternalServerError {
    id: string;
    message: string;
}
...
export declare class TranslateReqFailed extends InternalServerError {
    id: string;
    message: string;
}
