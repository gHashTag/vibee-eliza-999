...
import { ChannelType, type Content, type MemoryMetadata, type Character, type Action, type Evaluator, type Provider, type HandlerCallback, type IDatabaseAdapter, type Entity, type Room, type World, type SendHandlerFunction, type TargetInfo, type ModelParamsMap, type ModelResultMap, type ModelTypeName, type Plugin, type PluginEvents, type Route, type UUID, type Service, type ServiceTypeName, type State, type TaskWorker, type Agent, type Log, type Participant, type Relationship, type Task, type Memory, type ModelHandler, type RuntimeSettings, type Component, IAgentRuntime, type IElizaOS, type ActionResult, type GenerateTextOptions, type GenerateTextResult } from './types';
...
export declare class AgentRuntime implements IAgentRuntime {
    ...
    private saveSettingsToDatabase;
