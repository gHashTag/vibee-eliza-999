...
var getDurationMs = /* @__PURE__ */ __name((spanCard) => {
...
var formatDuration = /* @__PURE__ */ __name((durationMs) => {
...
var getTimelineData = /* @__PURE__ */ __name(({
  spanCard,
  minStart,
  maxEnd
}) => {
...
var flattenSpans = /* @__PURE__ */ __name((spans) => {
  const result = [];
...
__name(findTimeRange, "findTimeRange");
...
__name(getOpenTelemetryAttributeValue, "getOpenTelemetryAttributeValue");
...
__name(categorizeOpenInference, "categorizeOpenInference");
...
__name(categorizeOpenTelemetryGenAI, "categorizeOpenTelemetryGenAI");
...
__name(categorizeStandardOpenTelemetry, "categorizeStandardOpenTelemetry");
...
__name(convertNanoTimestampToDate, "convertNanoTimestampToDate");
...
__name(generateOpenTelemetrySpanTitle, "generateOpenTelemetrySpanTitle");
...
__name(getOpenTelemetrySpanStandard, "getOpenTelemetrySpanStandard");
