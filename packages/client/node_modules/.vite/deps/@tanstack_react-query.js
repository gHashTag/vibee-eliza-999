import {
  require_jsx_runtime
} from "./chunk-AJM2EZEJ.js";
import {
  require_react
} from "./chunk-F2GB7WGV.js";
import {
  __name,
  __privateAdd,
  __privateGet,
...
}, _provider = new WeakMap(), _providerCalled = new WeakMap(), __name(_a2, "TimeoutManager"), _a2);
...
var FocusManager = (_a3 = class extends Subscribable {
  ...
  onUnsubscribe() {
    ...
    if (!this.hasListeners()) {
      (_a16 = __privateGet(this, _cleanup)) == null ? void 0 : _a16.call(this);
...
}, _focused = new WeakMap(), _cleanup = new WeakMap(), _setup = new WeakMap(), __name(_a3, "FocusManager"), _a3);
...
__name(tryResolveSync, "tryResolveSync");
...
function dehydrateQuery(query, serializeData, shouldRedactErrors) {
  const dehydratePromise = /* @__PURE__ */ __name(() => {
...
var OnlineManager = (_a4 = class extends Subscribable {
  ...
  onUnsubscribe() {
    var _a16;
    if (!this.hasListeners()) {
      (_a16 = __privateGet(this, _cleanup2)) == null ? void 0 : _a16.call(this);
...
}, _online = new WeakMap(), _cleanup2 = new WeakMap(), _setup2 = new WeakMap(), __name(_a4, "OnlineManager"), _a4);
...
var _a5;
var CancelledError = (_a5 = class extends Error {
  constructor(options) {
    super("CancelledError");
    this.revert = options?.revert;
    this.silent = options?.silent;
  }
}, __name(_a5, "CancelledError"), _a5);
...
}, _gcTimeout = new WeakMap(), __name(_a6, "Removable"), _a6);

// ../../node_modules/@tanstack/query-core/build/modern/query.js
var _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, __this_instances, dispatch_fn, _a7;
var Query = (_a7 = class extends Removable {
  constructor(config) {
    super();
  ...
  async fetch(options, fetchOptions) {
    ...
    if (this.state.fetchStatus === "idle" || this.state.fetchMeta !== context.fetchOptions?.meta) {
      __privateMethod(this, __this_instances, dispatch_fn).call(this, { type: "fetch", meta: context.fetchOptions?.meta });
    }
...
}, _initialState = new WeakMap(), _revertState = new WeakMap(), _cache = new WeakMap(), _client = new WeakMap(), _retryer = new WeakMap(), _defaultOptions = new WeakMap(), _abortSignalConsumed = new WeakMap(), __this_instances = new WeakSet(), dispatch_fn = /* @__PURE__ */ __name(function(action) {
...
var QueryObserver = (_a8 = class extends Subscribable {
...
}, "#notify"), __name(_a8, "QueryObserver"), _a8);
...
var _a9;
var InfiniteQueryObserver = (_a9 = class extends QueryObserver {
  constructor(client, options) {
...
}, __name(_a9, "InfiniteQueryObserver"), _a9);

// ../../node_modules/@tanstack/query-core/build/modern/mutation.js
var _client3, _observers, _mutationCache, _retryer2, __this_instances3, dispatch_fn2, _a10;
var Mutation = (_a10 = class extends Removable {
  constructor(config) {
    super();
  ...
  async execute(variables) {
    ...
    __privateSet(this, _retryer2, createRetryer({
      ...
      onFail: /* @__PURE__ */ __name((failureCount, error) => {
        __privateMethod(this, __this_instances3, dispatch_fn2).call(this, { type: "failed", failureCount, error });
      }, "onFail"),
      onPause: /* @__PURE__ */ __name(() => {
        __privateMethod(this, __this_instances3, dispatch_fn2).call(this, { type: "pause" });
      }, "onPause"),
      onContinue,
    ...
    try {
      if (restored) {
        ...
        __privateMethod(this, __this_instances3, dispatch_fn2).call(this, { type: "pending", variables, isPaused });
      ...
      __privateMethod(this, __this_instances3, dispatch_fn2).call(this, { type: "success", data });
      return data;
    } catch (error) {
      try {
        ...
        __privateMethod(this, __this_instances3, dispatch_fn2).call(this, { type: "error", error });
      }
    } finally {
      __privateGet(this, _mutationCache).runNext(this);
    }
  }
}, _client3 = new WeakMap(), _observers = new WeakMap(), _mutationCache = new WeakMap(), _retryer2 = new WeakMap(), __this_instances3 = new WeakSet(), dispatch_fn2 = /* @__PURE__ */ __name(function(action) {
  const reducer = /* @__PURE__ */ __name((state) => {
    switch (action.type) {
      case "failed":
        return {
...
}, "#dispatch"), __name(_a10, "Mutation"), _a10);
...
var _mutations, _scopes, _mutationId, _a11;
var MutationCache = (_a11 = class extends Subscribable {
  constructor(config = {}) {
    super();
...
}, _mutations = new WeakMap(), _scopes = new WeakMap(), _mutationId = new WeakMap(), __name(_a11, "MutationCache"), _a11);
...
var _client4, _currentResult2, _currentMutation, _mutateOptions, __this_instances4, updateResult_fn, notify_fn2, _a12;
var MutationObserver = (_a12 = class extends Subscribable {
  constructor(client, options) {
    super();
...
}, _client4 = new WeakMap(), _currentResult2 = new WeakMap(), _currentMutation = new WeakMap(), _mutateOptions = new WeakMap(), __this_instances4 = new WeakSet(), updateResult_fn = /* @__PURE__ */ __name(function() {
...
}, "#notify"), __name(_a12, "MutationObserver"), _a12);
...
var _client5, _result, _queries, _options, _observers2, _combinedResult, _lastCombine, _lastResult, _observerMatches, __this_instances5, trackResult_fn, combineResult_fn, findMatchingObservers_fn, onUpdate_fn, notify_fn3, _a13;
var QueriesObserver = (_a13 = class extends Subscribable {
  constructor(client, queries, options) {
    super();
    __privateAdd(this, __this_instances5);
    ...
    if (this.listeners.size === 1) {
      __privateGet(this, _observers2).forEach((observer) => {
        observer.subscribe((result) => {
          __privateMethod(this, __this_instances5, onUpdate_fn).call(this, observer, result);
        });
      });
    }
  }
  ...
  setQueries(queries, options) {
    ...
    notifyManager.batch(() => {
      ...
      const newObserverMatches = __privateMethod(this, __this_instances5, findMatchingObservers_fn).call(this, __privateGet(this, _queries));
      ...
      __privateMethod(this, __this_instances5, notify_fn3).call(this);
    });
  }
  getCurrentResult() {
  ...
  getOptimisticResult(queries, combine) {
    const matches = __privateMethod(this, __this_instances5, findMatchingObservers_fn).call(this, queries);
    ...
    return [
      result,
      (r) => {
        return __privateMethod(this, __this_instances5, combineResult_fn).call(this, r ?? result, combine);
      },
      () => {
        return __privateMethod(this, __this_instances5, trackResult_fn).call(this, result, matches);
      }
    ];
  }
}, _client5 = new WeakMap(), _result = new WeakMap(), _queries = new WeakMap(), _options = new WeakMap(), _observers2 = new WeakMap(), _combinedResult = new WeakMap(), _lastCombine = new WeakMap(), _lastResult = new WeakMap(), _observerMatches = new WeakMap(), __this_instances5 = new WeakSet(), trackResult_fn = /* @__PURE__ */ __name(function(result, matches) {
...
}, "#trackResult"), combineResult_fn = /* @__PURE__ */ __name(function(input, combine) {
  if (combine) {
  ...
  return input;
}, "#combineResult"), findMatchingObservers_fn = /* @__PURE__ */ __name(function(queries) {
  ...
  if (this.hasListeners()) {
    ...
    const newTracked = __privateMethod(this, __this_instances5, trackResult_fn).call(this, __privateGet(this, _result), __privateGet(this, _observerMatches));
    const newResult = __privateMethod(this, __this_instances5, combineResult_fn).call(this, newTracked, __privateGet(this, _options)?.combine);
...
}, "#notify"), __name(_a13, "QueriesObserver"), _a13);

// ../../node_modules/@tanstack/query-core/build/modern/queryCache.js
var _queries2, _a14;
var QueryCache = (_a14 = class extends Subscribable {
  constructor(config = {}) {
    super();
...
}, _queries2 = new WeakMap(), __name(_a14, "QueryCache"), _a14);

// ../../node_modules/@tanstack/query-core/build/modern/queryClient.js
var _queryCache, _mutationCache2, _defaultOptions2, _queryDefaults, _mutationDefaults, _mountCount, _unsubscribeFocus, _unsubscribeOnline, _a15;
var QueryClient = (_a15 = class {
  constructor(config = {}) {
  ...
  unmount() {
    ...
    (_a16 = __privateGet(this, _unsubscribeFocus)) == null ? void 0 : _a16.call(this);
...
}, _queryCache = new WeakMap(), _mutationCache2 = new WeakMap(), _defaultOptions2 = new WeakMap(), _queryDefaults = new WeakMap(), _mutationDefaults = new WeakMap(), _mountCount = new WeakMap(), _unsubscribeFocus = new WeakMap(), _unsubscribeOnline = new WeakMap(), __name(_a15, "QueryClient"), _a15);

// ../../node_modules/@tanstack/query-core/build/modern/streamedQuery.js
function streamedQuery({
  streamFn,
  refetchMode = "reset",
  reducer = /* @__PURE__ */ __name((items, chunk) => addToEnd(items, chunk), "reducer"),
  initialValue = []
}) {
...
__name(streamedQuery, "streamedQuery");
...
var useIsRestoring = /* @__PURE__ */ __name(() => React2.useContext(IsRestoringContext), "useIsRestoring");
...
var useQueryErrorResetBoundary = /* @__PURE__ */ __name(() => React3.useContext(QueryErrorResetBoundaryContext), "useQueryErrorResetBoundary");
var QueryErrorResetBoundary = /* @__PURE__ */ __name(({
  children
}) => {
...
var defaultThrowOnError = /* @__PURE__ */ __name((_error, query) => query.state.data === void 0, "defaultThrowOnError");
...
__name(useSuspenseQuery, "useSuspenseQuery");
...
__name(useSuspenseInfiniteQuery, "useSuspenseInfiniteQuery");
...
__name(useSuspenseQueries, "useSuspenseQueries");
...
__name(usePrefetchQuery, "usePrefetchQuery");
...
__name(usePrefetchInfiniteQuery, "usePrefetchInfiniteQuery");
...
__name(infiniteQueryOptions, "infiniteQueryOptions");

// ../../node_modules/@tanstack/react-query/build/modern/HydrationBoundary.js
var React7 = __toESM(require_react(), 1);
var HydrationBoundary = /* @__PURE__ */ __name(({
  children,
  options = {},
  state,
  queryClient
...
__name(useIsFetching, "useIsFetching");
...
__name(useIsMutating, "useIsMutating");
...
__name(useMutationState, "useMutationState");
...
__name(mutationOptions, "mutationOptions");
