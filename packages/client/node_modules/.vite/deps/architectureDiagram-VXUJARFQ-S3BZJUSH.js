...
var ArchitectureDirectionArrow = {
  L: __name2((scale) => `${scale},${scale / 2} 0,${scale} 0,0`, "L"),
  R: __name2((scale) => `0,${scale / 2} ${scale},0 ${scale},${scale}`, "R"),
  T: __name2((scale) => `0,0 ${scale},0 ${scale / 2},${scale}`, "T"),
  B: __name2((scale) => `${scale / 2},0 ${scale},${scale} 0,${scale}`, "B")
};
var ArchitectureDirectionArrowShift = {
  L: __name2((orig, arrowSize) => orig - arrowSize + 2, "L"),
  R: __name2((orig, _arrowSize) => orig - 2, "R"),
  T: __name2((orig, arrowSize) => orig - arrowSize + 2, "T"),
  B: __name2((orig, _arrowSize) => orig - 2, "B")
};
var getOppositeArchitectureDirection = __name2(function(x) {
...
var isArchitectureDirection = __name2(function(x) {
  const temp = x;
  return temp === "L" || temp === "R" || temp === "T" || temp === "B";
}, "isArchitectureDirection");
var isArchitectureDirectionX = __name2(function(x) {
  const temp = x;
  return temp === "L" || temp === "R";
}, "isArchitectureDirectionX");
var isArchitectureDirectionY = __name2(function(x) {
  const temp = x;
  return temp === "T" || temp === "B";
}, "isArchitectureDirectionY");
var isArchitectureDirectionXY = __name2(function(a, b) {
  const aX_bY = isArchitectureDirectionX(a) && isArchitectureDirectionY(b);
  const aY_bX = isArchitectureDirectionY(a) && isArchitectureDirectionX(b);
  return aX_bY || aY_bX;
}, "isArchitectureDirectionXY");
var isArchitecturePairXY = __name2(function(pair) {
  const lhs = pair[0];
  const rhs = pair[1];
...
var isValidArchitectureDirectionPair = __name2(function(x) {
  return x !== "LL" && x !== "RR" && x !== "TT" && x !== "BB";
}, "isValidArchitectureDirectionPair");
var getArchitectureDirectionPair = __name2(function(sourceDir, targetDir) {
  const pair = `${sourceDir}${targetDir}`;
  return isValidArchitectureDirectionPair(pair) ? pair : void 0;
}, "getArchitectureDirectionPair");
var shiftPositionByArchitectureDirectionPair = __name2(function([x, y], pair) {
  const lhs = pair[0];
  const rhs = pair[1];
...
var getArchitectureDirectionXYFactors = __name2(function(pair) {
  if (pair === "LT" || pair === "TL") {
    return [1, 1];
...
var getArchitectureDirectionAlignment = __name2(function(a, b) {
...
var isArchitectureService = __name2(function(x) {
  const temp = x;
  return temp.type === "service";
}, "isArchitectureService");
var isArchitectureJunction = __name2(function(x) {
  const temp = x;
  return temp.type === "junction";
}, "isArchitectureJunction");
var edgeData = __name2((edge) => {
  return edge.data();
}, "edgeData");
var nodeData = __name2((node) => {
  return node.data();
}, "nodeData");
...
}, __name(_a, "ArchitectureDB"), __name2(_a, "ArchitectureDB"), _a);
var populateDb = __name2((ast, db) => {
...
var drawEdges = __name2(async function(edgesEl, cy, db) {
...
var drawGroups = __name2(async function(groupsEl, cy, db) {
  const padding = db.getConfigField("padding");
...
var drawServices = __name2(async function(db, elem, services) {
...
var drawJunctions = __name2(function(db, elem, junctions) {
...
__name2(addServices, "addServices");
...
__name2(addJunctions, "addJunctions");
...
__name2(positionNodes, "positionNodes");
...
__name2(addEdges, "addEdges");
function getAlignments(db, spatialMaps, groupAlignments) {
  const flattenAlignments = __name2((alignmentObj, alignmentDir) => {
...
__name2(getAlignments, "getAlignments");
function getRelativeConstraints(spatialMaps, db) {
  const relativeConstraints = [];
  const posToStr = __name2((pos) => `${pos[0]},${pos[1]}`, "posToStr");
  const strToPos = __name2((pos) => pos.split(",").map((p) => parseInt(p)), "strToPos");
...
__name2(getRelativeConstraints, "getRelativeConstraints");
function layoutArchitecture(services, junctions, groups, edges, db, { spatialMaps, groupAlignments }) {
  return new Promise((resolve) => {
    ...
    layout.one("layoutstop", () => {
      ...
      __name2(getSegmentWeights, "getSegmentWeights");
      cy.startBatch();
...
__name2(layoutArchitecture, "layoutArchitecture");
var draw = __name2(async (text, id, _version, diagObj) => {
  const db = diagObj.db;
...
//# sourceMappingURL=architectureDiagram-VXUJARFQ-S3BZJUSH.js.map
