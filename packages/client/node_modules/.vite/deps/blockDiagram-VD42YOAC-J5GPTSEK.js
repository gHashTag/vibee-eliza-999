import {
  Graph
} from "./chunk-TBUAWA4L.js";
import {
  getIconStyles
} from "./chunk-N7ESY4XT.js";
import {
  getLineFunctionsWithOffset
} from "./chunk-YLMRSC2L.js";
import {
  getSubGraphTitleMargins
} from "./chunk-CIUECYE5.js";
import {
  createText,
...
var sanitizeText2 = __name2((txt) => common_default.sanitizeText(txt, config), "sanitizeText");
var addStyleClass = __name2(function(id, styleAttributes = "") {
...
var addStyle2Node = __name2(function(id, styles = "") {
  const foundBlock = blockDatabase.get(id);
  if (styles !== void 0 && styles !== null) {
    foundBlock.styles = styles.split(STYLECLASS_SEP);
  }
}, "addStyle2Node");
var setCssClass = __name2(function(itemIds, cssClassName) {
...
var populateBlockDatabase = __name2((_blockList, parent) => {
...
__name2(typeStr2Type, "typeStr2Type");
...
__name2(edgeTypeStr2Type, "edgeTypeStr2Type");
...
__name2(edgeStrToEdgeData, "edgeStrToEdgeData");
var cnt = 0;
var generateId = __name2(() => {
  cnt++;
  return "id-" + Math.random().toString(36).substr(2, 12) + "-" + cnt;
}, "generateId");
var setHierarchy = __name2((block) => {
  rootBlock.children = block;
  populateBlockDatabase(block, rootBlock);
  blocks = rootBlock.children;
}, "setHierarchy");
var getColumns = __name2((blockId) => {
...
var getBlocksFlat = __name2(() => {
  return [...blockDatabase.values()];
}, "getBlocksFlat");
var getBlocks = __name2(() => {
  return blocks || [];
}, "getBlocks");
var getEdges = __name2(() => {
  return edgeList;
}, "getEdges");
var getBlock = __name2((id) => {
  return blockDatabase.get(id);
}, "getBlock");
var setBlock = __name2((block) => {
  blockDatabase.set(block.id, block);
}, "setBlock");
var getLogger = __name2(() => log, "getLogger");
var getClasses = __name2(function() {
  return classes;
}, "getClasses");
var db = {
  getConfig: __name2(() => getConfig().block, "getConfig"),
  typeStr2Type,
  edgeTypeStr2Type,
  edgeStrToEdgeData,
  getLogger,
...
var fade = __name2((color, opacity) => {
...
var getStyles = __name2((options) => `.label {
...
__name2(calculateBlockPosition, "calculateBlockPosition");
var getMaxChildSize = __name2((block) => {
  let maxWidth = 0;
  let maxHeight = 0;
...
__name2(setBlockSizes, "setBlockSizes");
...
__name2(layoutBlocks, "layoutBlocks");
...
__name2(addHtmlLabel, "addHtmlLabel");
var createLabel = __name2(async (_vertexText, style, isTitle, isNode) => {
...
var addEdgeMarkers = __name2((svgPath, edge, url, id, diagramType) => {
...
var addEdgeMarker = __name2((svgPath, position, arrowType, url, id, diagramType) => {
...
var edgeLabels = {};
var terminalLabels = {};
var insertEdgeLabel = __name2(async (elem, edge) => {
  const config2 = getConfig2();
...
__name2(setTerminalWidth, "setTerminalWidth");
var positionEdgeLabel = __name2((edge, paths) => {
...
var outsideNode = __name2((node, point2) => {
  const x = node.x;
  const y = node.y;
...
var intersection = __name2((node, outsidePoint, insidePoint) => {
...
var cutPathAtIntersect = __name2((_points, boundaryNode) => {
...
var insertEdge = __name2(function(elem, e, edge, clusterDb, diagramType, graph, id) {
...
var expandAndDeduplicateDirections = __name2((directions) => {
...
var getArrowPoints = __name2((duplicatedDirections, bbox, node) => {
...
__name2(intersectNode, "intersectNode");
...
__name2(intersectEllipse, "intersectEllipse");
var intersect_ellipse_default = intersectEllipse;
function intersectCircle(node, rx, point2) {
  return intersect_ellipse_default(node, rx, rx, point2);
}
__name(intersectCircle, "intersectCircle");
__name2(intersectCircle, "intersectCircle");
...
__name2(intersectLine, "intersectLine");
function sameSign(r1, r2) {
  return r1 * r2 > 0;
}
__name(sameSign, "sameSign");
__name2(sameSign, "sameSign");
...
__name2(intersectPolygon, "intersectPolygon");
var intersectRect = __name2((node, point2) => {
  var x = node.x;
  var y = node.y;
  var dx = point2.x - x;
  var dy = point2.y - y;
...
var labelHelper = __name2(async (parent, node, _classes, isNode) => {
  const config2 = getConfig2();
  let classes2;
...
var updateNodeBounds = __name2((node, element) => {
...
__name2(insertPolygonShape, "insertPolygonShape");
var note = __name2(async (parent, node) => {
...
var formatClass = __name2((str) => {
  if (str) {
    return " " + str;
  }
  return "";
}, "formatClass");
var getClassesFromNode = __name2((node, otherClasses) => {
  return `${otherClasses ? otherClasses : "node default"}${formatClass(node.classes)} ${formatClass(
    node.class
  )}`;
}, "getClassesFromNode");
var question = __name2(async (parent, node) => {
...
var choice = __name2((parent, node) => {
...
var hexagon = __name2(async (parent, node) => {
  const { shapeSvg, bbox } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var block_arrow = __name2(async (parent, node) => {
...
var rect_left_inv_arrow = __name2(async (parent, node) => {
  const { shapeSvg, bbox } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var lean_right = __name2(async (parent, node) => {
...
var lean_left = __name2(async (parent, node) => {
  const { shapeSvg, bbox } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var trapezoid = __name2(async (parent, node) => {
  const { shapeSvg, bbox } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var inv_trapezoid = __name2(async (parent, node) => {
  const { shapeSvg, bbox } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var rect_right_inv_arrow = __name2(async (parent, node) => {
  const { shapeSvg, bbox } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var cylinder = __name2(async (parent, node) => {
  const { shapeSvg, bbox } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var rect = __name2(async (parent, node) => {
  const { shapeSvg, bbox, halfPadding } = await labelHelper(
    parent,
    node,
...
var composite = __name2(async (parent, node) => {
  const { shapeSvg, bbox, halfPadding } = await labelHelper(
    parent,
    node,
    "node " + node.classes,
...
var labelRect = __name2(async (parent, node) => {
...
function applyNodePropertyBorders(rect2, borders, totalWidth, totalHeight) {
  ...
  const addBorder = __name2((length) => {
    strokeDashArray.push(length, 0);
  }, "addBorder");
  const skipBorder = __name2((length) => {
...
__name2(applyNodePropertyBorders, "applyNodePropertyBorders");
var rectWithTitle = __name2(async (parent, node) => {
  let classes2;
  if (!node.classes) {
    classes2 = "node default";
  } else {
...
var stadium = __name2(async (parent, node) => {
  const { shapeSvg, bbox } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var circle2 = __name2(async (parent, node) => {
  const { shapeSvg, bbox, halfPadding } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var doublecircle = __name2(async (parent, node) => {
  const { shapeSvg, bbox, halfPadding } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var subroutine = __name2(async (parent, node) => {
  const { shapeSvg, bbox } = await labelHelper(
    parent,
    node,
    getClassesFromNode(node, void 0),
...
var forkJoin = __name2((parent, node, dir) => {
  const shapeSvg = parent.insert("g").attr("class", "node default").attr("id", node.domId || node.id);
  let width = 70;
  let height = 10;
  if (dir === "LR") {
...
var class_box = __name2(async (parent, node) => {
  const halfPadding = node.padding / 2;
  const rowPadding = 4;
  const lineHeight = 8;
  let classes2;
...
var nodeElems = {};
var insertNode = __name2(async (elem, node, renderOptions) => {
  let newEl;
  let el;
  if (node.link) {
    let target;
...
__name2(getNodeFromBlock, "getNodeFromBlock");
...
__name2(calculateBlockSize, "calculateBlockSize");
...
__name2(insertBlockPositioned, "insertBlockPositioned");
...
__name2(performOperations, "performOperations");
async function calculateBlockSizes(elem, blocks2, db2) {
  await performOperations(elem, blocks2, db2, calculateBlockSize);
}
__name(calculateBlockSizes, "calculateBlockSizes");
__name2(calculateBlockSizes, "calculateBlockSizes");
async function insertBlocks(elem, blocks2, db2) {
  await performOperations(elem, blocks2, db2, insertBlockPositioned);
}
__name(insertBlocks, "insertBlocks");
__name2(insertBlocks, "insertBlocks");
...
__name2(insertEdges, "insertEdges");
var getClasses2 = __name2(function(text, diagObj) {
  return diagObj.db.getClasses();
}, "getClasses");
var draw = __name2(async function(text, id, _version, diagObj) {
...
//# sourceMappingURL=blockDiagram-VD42YOAC-J5GPTSEK.js.map
