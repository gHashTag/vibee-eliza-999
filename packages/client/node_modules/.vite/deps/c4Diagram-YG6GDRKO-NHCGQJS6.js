...
var c4Type;
var getC4Type = __name2(function() {
  return c4Type;
}, "getC4Type");
var setC4Type = __name2(function(c4TypeParam) {
  let sanitizedText = sanitizeText(c4TypeParam, getConfig2());
  c4Type = sanitizedText;
}, "setC4Type");
var addRel = __name2(function(type, from, to, label, techn, descr, sprite, tags, link) {
...
var addPersonOrSystem = __name2(function(typeC4Shape, alias, label, descr, sprite, tags, link) {
...
var addContainer = __name2(function(typeC4Shape, alias, label, techn, descr, sprite, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let container = {};
...
var addComponent = __name2(function(typeC4Shape, alias, label, techn, descr, sprite, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let component = {};
...
var addPersonOrSystemBoundary = __name2(function(alias, label, type, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let boundary = {};
...
var addContainerBoundary = __name2(function(alias, label, type, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let boundary = {};
...
var addDeploymentNode = __name2(function(nodeType, alias, label, type, descr, sprite, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let boundary = {};
...
var popBoundaryParseStack = __name2(function() {
  currentBoundaryParse = parentBoundaryParse;
  boundaryParseStack.pop();
  parentBoundaryParse = boundaryParseStack.pop();
  boundaryParseStack.push(parentBoundaryParse);
}, "popBoundaryParseStack");
var updateElStyle = __name2(function(typeC4Shape, elementName, bgColor, fontColor, borderColor, shadowing, shape, sprite, techn, legendText, legendSprite) {
...
var updateRelStyle = __name2(function(typeC4Shape, from, to, textColor, lineColor, offsetX, offsetY) {
...
var updateLayoutConfig = __name2(function(typeC4Shape, c4ShapeInRowParam, c4BoundaryInRowParam) {
...
var getC4ShapeInRow = __name2(function() {
  return c4ShapeInRow;
}, "getC4ShapeInRow");
var getC4BoundaryInRow = __name2(function() {
  return c4BoundaryInRow;
}, "getC4BoundaryInRow");
var getCurrentBoundaryParse = __name2(function() {
  return currentBoundaryParse;
}, "getCurrentBoundaryParse");
var getParentBoundaryParse = __name2(function() {
  return parentBoundaryParse;
}, "getParentBoundaryParse");
var getC4ShapeArray = __name2(function(parentBoundary) {
...
var getC4Shape = __name2(function(alias) {
  return c4ShapeArray.find((personOrSystem) => personOrSystem.alias === alias);
}, "getC4Shape");
var getC4ShapeKeys = __name2(function(parentBoundary) {
  return Object.keys(getC4ShapeArray(parentBoundary));
}, "getC4ShapeKeys");
var getBoundaries = __name2(function(parentBoundary) {
  if (parentBoundary === void 0 || parentBoundary === null) {
    return boundaries;
  } else {
...
var getRels = __name2(function() {
  return rels;
}, "getRels");
var getTitle = __name2(function() {
  return title;
}, "getTitle");
var setWrap = __name2(function(wrapSetting) {
  wrapEnabled = wrapSetting;
}, "setWrap");
var autoWrap = __name2(function() {
  return wrapEnabled;
}, "autoWrap");
var clear = __name2(function() {
  c4ShapeArray = [];
  boundaries = [
    {
      alias: "global",
...
var setTitle = __name2(function(txt) {
...
var c4Db_default = {
  ...
  getAccDescription,
  setAccDescription,
  getConfig: __name2(() => getConfig2().c4, "getConfig"),
  clear,
  LINETYPE,
  ARROWTYPE,
  PLACEMENT,
...
var drawImage = __name2(function(elem, width, height, x, y, link) {
...
var drawRels = __name2((elem, rels2, conf2) => {
...
var drawBoundary = __name2(function(elem, boundary, conf2) {
...
var drawC4Shape = __name2(function(elem, c4Shape, conf2) {
...
var insertArrowEnd = __name2(function(elem) {
...
var insertDynamicNumber = __name2(function(elem) {
...
var getC4ShapeFont = __name2((cnf, typeC4Shape) => {
  return {
...
}, __name(_a, "Bounds"), __name2(_a, "Bounds"), _a);
...
var c4ShapeFont = __name2((cnf, typeC4Shape) => {
  return {
    fontFamily: cnf[typeC4Shape + "FontFamily"],
    fontSize: cnf[typeC4Shape + "FontSize"],
    fontWeight: cnf[typeC4Shape + "FontWeight"]
...
__name2(calcC4ShapeTextWH, "calcC4ShapeTextWH");
var drawBoundary2 = __name2(function(diagram2, boundary, bounds) {
...
var drawC4ShapeArray = __name2(function(currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
  let Y = 0;
...
}, __name(_a2, "Point"), __name2(_a2, "Point"), _a2);
var getIntersectPoint = __name2(function(fromNode, endPoint) {
  let x1 = fromNode.x;
  let y1 = fromNode.y;
  let x2 = endPoint.x;
  let y2 = endPoint.y;
...
var getIntersectPoints = __name2(function(fromNode, endNode) {
...
var drawRels2 = __name2(function(diagram2, rels2, getC4ShapeObj, diagObj) {
  let i = 0;
  for (let rel of rels2) {
    i = i + 1;
...
__name2(drawInsideBoundary, "drawInsideBoundary");
var draw = __name2(function(_text, id, _version, diagObj) {
  conf = getConfig2().c4;
...
var getStyles = __name2((options) => `.person {
...
//# sourceMappingURL=c4Diagram-YG6GDRKO-NHCGQJS6.js.map
