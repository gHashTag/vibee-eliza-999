import {
  getDiagramElement
} from "./chunk-2AM7SJHS.js";
import {
  setupViewPortForSVG
} from "./chunk-EBGYA74L.js";
import {
  render
...
var getDir = __name2((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = __name2(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = __name2(async function(text, id, _version, diag) {
  log.info("REF0:");
...
__name2(stateDomId, "stateDomId");
var setupDoc = __name2((parentParsedItem, doc, diagramStates, nodes, edges, altFlag, look, classes) => {
  log.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
...
var getDir2 = __name2((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
    for (const parsedItemDoc of parsedItem.doc) {
      if (parsedItemDoc.stmt === "dir") {
...
__name2(insertOrUpdateNode, "insertOrUpdateNode");
function getClassesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.classes?.join(" ") ?? "";
}
__name(getClassesFromDbInfo, "getClassesFromDbInfo");
__name2(getClassesFromDbInfo, "getClassesFromDbInfo");
function getStylesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.styles ?? [];
}
__name(getStylesFromDbInfo, "getStylesFromDbInfo");
__name2(getStylesFromDbInfo, "getStylesFromDbInfo");
var dataFetcher = __name2((parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
...
var newClassesList = __name2(() => /* @__PURE__ */ new Map(), "newClassesList");
var newDoc = __name2(() => ({
  relations: [],
  states: /* @__PURE__ */ new Map(),
  documents: {}
}), "newDoc");
var clone = __name2((o) => JSON.parse(JSON.stringify(o)), "clone");
var _a;
...
}, __name(_a, "StateDB"), __name2(_a, "StateDB"), _a.relationType = {
  AGGREGATION: 0,
  EXTENSION: 1,
  COMPOSITION: 2,
  DEPENDENCY: 3
...
//# sourceMappingURL=chunk-4XLCEMNX.js.map
