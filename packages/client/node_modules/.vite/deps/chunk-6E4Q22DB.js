...
if (!apply) {
  apply = /* @__PURE__ */ __name(function apply2(func, thisArg) {
...
}, __name(_a, "UnknownDiagramError"), __name2(_a, "UnknownDiagramError"), _a);
var detectors = {};
var detectType = __name2(function(text2, config2) {
...
var registerLazyLoadedDiagrams = __name2((...diagrams2) => {
  for (const { id, detector, loader } of diagrams2) {
    addDetector(id, detector, loader);
  }
}, "registerLazyLoadedDiagrams");
var addDetector = __name2((key, detector, loader) => {
  if (detectors[key]) {
...
var getDiagramLoader = __name2((key) => {
  return detectors[key].loader;
}, "getDiagramLoader");
var assignWithDepth = __name2((dst, src, { depth = 2, clobber = false } = {}) => {
...
var mkBorder = __name2((col, darkMode) => darkMode ? adjust_default(col, { s: -40, l: 10 }) : adjust_default(col, { s: -40, l: -10 }), "mkBorder");
var _a2;
var Theme = (_a2 = class {
  constructor() {
...
}, __name(_a2, "Theme"), __name2(_a2, "Theme"), _a2);
var getThemeVariables = __name2((userOverrides) => {
...
}, __name(_a3, "Theme2"), __name2(_a3, "Theme"), _a3);
var getThemeVariables2 = __name2((userOverrides) => {
...
}, __name(_a4, "Theme3"), __name2(_a4, "Theme"), _a4);
var getThemeVariables3 = __name2((userOverrides) => {
...
}, __name(_a5, "Theme4"), __name2(_a5, "Theme"), _a5);
var getThemeVariables4 = __name2((userOverrides) => {
...
}, __name(_a6, "Theme5"), __name2(_a6, "Theme"), _a6);
var getThemeVariables5 = __name2((userOverrides) => {
...
var config = {
  ...
  c4: {
    ...
    external_personFont: __name2(function() {
      return {
    ...
    external_systemFont: __name2(function() {
      return {
    ...
    system_dbFont: __name2(function() {
      return {
    ...
    external_system_dbFont: __name2(function() {
      return {
    ...
    system_queueFont: __name2(function() {
      return {
    ...
    external_system_queueFont: __name2(function() {
      return {
    ...
    containerFont: __name2(function() {
      return {
    ...
    external_containerFont: __name2(function() {
      return {
    ...
    container_dbFont: __name2(function() {
      return {
    ...
    external_container_dbFont: __name2(function() {
      return {
    ...
    container_queueFont: __name2(function() {
      return {
    ...
    external_container_queueFont: __name2(function() {
      return {
    ...
    componentFont: __name2(function() {
      return {
    ...
    external_componentFont: __name2(function() {
      return {
    ...
    component_dbFont: __name2(function() {
      return {
    ...
    external_component_dbFont: __name2(function() {
      return {
    ...
    component_queueFont: __name2(function() {
      return {
    ...
    external_component_queueFont: __name2(function() {
      return {
...
var keyify = __name2((obj, prefix = "") => Object.keys(obj).reduce((res, el) => {
...
var sanitizeDirective = __name2((args) => {
...
var updateCurrentConfig = __name2((siteCfg, _directives) => {
...
var setSiteConfig = __name2((conf) => {
...
var addDirective = __name2((directive) => {
...
var reset = __name2((config2 = siteConfig) => {
  directives = [];
...
var issuedWarnings = {};
var issueWarning = __name2((warning) => {
...
var checkConfig = __name2((config2) => {
  if (!config2) {
    return;
  }
...
var getUserDefinedConfig = __name2(() => {
  let userConfig = {};
...
__name2(setupDompurifyHooks, "setupDompurifyHooks");
var removeScript = __name2((txt) => {
  setupDompurifyHooksIfNotSetup();
  const sanitizedText = purify.sanitize(txt);
  return sanitizedText;
}, "removeScript");
var sanitizeMore = __name2((text2, config2) => {
...
var sanitizeText = __name2((text2, config2) => {
  if (!text2) {
    return text2;
  }
...
var sanitizeTextOrArray = __name2((a, config2) => {
  if (typeof a === "string") {
    return sanitizeText(a, config2);
  }
  return a.flat().map((x) => sanitizeText(x, config2));
}, "sanitizeTextOrArray");
var hasBreaks = __name2((text2) => {
  return lineBreakRegex.test(text2);
}, "hasBreaks");
var splitBreaks = __name2((text2) => {
  return text2.split(lineBreakRegex);
}, "splitBreaks");
var placeholderToBreak = __name2((s) => {
  return s.replace(/#br#/g, "<br/>");
}, "placeholderToBreak");
var breakToPlaceholder = __name2((s) => {
  return s.replace(lineBreakRegex, "#br#");
}, "breakToPlaceholder");
var getUrl = __name2((useAbsolute) => {
  let url = "";
  if (useAbsolute) {
...
var evaluate = __name2((val) => val === false || ["false", "null", "0"].includes(String(val).trim().toLowerCase()) ? false : true, "evaluate");
var getMax = __name2(function(...values) {
  const newValues = values.filter((value) => {
    return !isNaN(value);
  });
  return Math.max(...newValues);
}, "getMax");
var getMin = __name2(function(...values) {
  const newValues = values.filter((value) => {
    return !isNaN(value);
  });
  return Math.min(...newValues);
}, "getMin");
var parseGenericTypes = __name2(function(input) {
...
var countOccurrence = __name2((string, substring) => {
  return Math.max(0, string.split(substring).length - 1);
}, "countOccurrence");
var shouldCombineSets = __name2((previousSet, nextSet) => {
  const prevCount = countOccurrence(previousSet, "~");
  const nextCount = countOccurrence(nextSet, "~");
  return prevCount === 1 && nextCount === 1;
}, "shouldCombineSets");
var processSet = __name2((input) => {
...
var isMathMLSupported = __name2(() => window.MathMLElement !== void 0, "isMathMLSupported");
var katexRegex = /\$\$(.*)\$\$/g;
var hasKatex = __name2((text2) => (text2.match(katexRegex)?.length ?? 0) > 0, "hasKatex");
var calculateMathMLDimensions = __name2(async (text2, config2) => {
...
var renderKatexUnsanitized = __name2(async (text2, config2) => {
  if (!hasKatex(text2)) {
    return text2;
  }
  ...
  if (true) {
    const { default: katex } = await import("./katex-ANR7QUMH.js");
...
var renderKatexSanitized = __name2(async (text2, config2) => {
...
var d3Attrs = __name2(function(d3Elem, attrs) {
  for (let attr of attrs) {
    d3Elem.attr(attr[0], attr[1]);
  }
}, "d3Attrs");
var calculateSvgSizeAttrs = __name2(function(height, width, useMaxWidth) {
...
var configureSvgSize = __name2(function(svgElem, height, width, useMaxWidth) {
  const attrs = calculateSvgSizeAttrs(height, width, useMaxWidth);
  d3Attrs(svgElem, attrs);
}, "configureSvgSize");
var setupGraphViewbox = __name2(function(graph, svgElem, padding, useMaxWidth) {
...
var themes = {};
var getStyles = __name2((type, userStyles, options) => {
  let diagramStyles = "";
...
var addStylesForDiagram = __name2((type, diagramTheme) => {
...
__export(commonDb_exports, {
  clear: /* @__PURE__ */ __name(() => clear, "clear"),
  getAccDescription: /* @__PURE__ */ __name(() => getAccDescription, "getAccDescription"),
  getAccTitle: /* @__PURE__ */ __name(() => getAccTitle, "getAccTitle"),
  getDiagramTitle: /* @__PURE__ */ __name(() => getDiagramTitle, "getDiagramTitle"),
  setAccDescription: /* @__PURE__ */ __name(() => setAccDescription, "setAccDescription"),
  setAccTitle: /* @__PURE__ */ __name(() => setAccTitle, "setAccTitle"),
  setDiagramTitle: /* @__PURE__ */ __name(() => setDiagramTitle, "setDiagramTitle")
});
var accTitle = "";
var diagramTitle = "";
var accDescription = "";
var sanitizeText2 = __name2((txt) => sanitizeText(txt, getConfig()), "sanitizeText");
var clear = __name2(() => {
  accTitle = "";
  accDescription = "";
  diagramTitle = "";
}, "clear");
var setAccTitle = __name2((txt) => {
  accTitle = sanitizeText2(txt).replace(/^\s+/g, "");
}, "setAccTitle");
var getAccTitle = __name2(() => accTitle, "getAccTitle");
var setAccDescription = __name2((txt) => {
  accDescription = sanitizeText2(txt).replace(/\n\s+/g, "\n");
}, "setAccDescription");
var getAccDescription = __name2(() => accDescription, "getAccDescription");
var setDiagramTitle = __name2((txt) => {
  diagramTitle = sanitizeText2(txt);
}, "setDiagramTitle");
var getDiagramTitle = __name2(() => diagramTitle, "getDiagramTitle");
var log2 = log;
var setLogLevel2 = setLogLevel;
var getConfig2 = getConfig;
var setConfig2 = setConfig;
var defaultConfig2 = defaultConfig;
var sanitizeText3 = __name2((text2) => sanitizeText(text2, getConfig2()), "sanitizeText");
var setupGraphViewbox2 = setupGraphViewbox;
var getCommonDb = __name2(() => {
  return commonDb_exports;
}, "getCommonDb");
var diagrams = {};
var registerDiagram = __name2((id, diagram, detector) => {
  if (diagrams[id]) {
...
}, __name(_a7, "DiagramNotFoundError"), __name2(_a7, "DiagramNotFoundError"), _a7);
...
//# sourceMappingURL=chunk-6E4Q22DB.js.map
