import {
  ...
  uniq_default,
  values_default
} from "./chunk-5XX4YITM.js";
import {
  isEmpty_default
} from "./chunk-PZFG4ADV.js";
import {
  identity_default,
  isArray_default,
  isFunction_default,
  isObject_default
} from "./chunk-THEGQYF3.js";
import {
  __commonJS,
  __export,
  __name,
...
var require_cancellation = __commonJS({
  "../../node_modules/vscode-jsonrpc/lib/common/cancellation.js"(exports) {
    ...
    var _MutableToken = class _MutableToken {
      constructor() {
    ...
    var _CancellationTokenSource = class _CancellationTokenSource {
      get token() {
        if (!this._token) {
    ...
    var CancellationTokenSource3 = _CancellationTokenSource;
...
var _AbstractAstReflection = class _AbstractAstReflection {
  constructor() {
    this.subtypes = {};
    this.allSubtypes = {};
  }
...
__name(_AbstractAstReflection, "AbstractAstReflection");
var AbstractAstReflection = _AbstractAstReflection;
...
var _TreeStreamImpl = class _TreeStreamImpl extends StreamImpl {
...
__name(_TreeStreamImpl, "TreeStreamImpl");
var TreeStreamImpl = _TreeStreamImpl;
var Reduction;
(function(Reduction2) {
...
var _ErrorWithLocation = class _ErrorWithLocation extends Error {
  constructor(node, message) {
    super(node ? `${message} at ${node.range.start.line}:${node.range.start.character}` : message);
  }
};
__name(_ErrorWithLocation, "ErrorWithLocation");
var ErrorWithLocation = _ErrorWithLocation;
...
var _LangiumGrammarAstReflection = class _LangiumGrammarAstReflection extends AbstractAstReflection {
  getAllTypes() {
...
__name(_LangiumGrammarAstReflection, "LangiumGrammarAstReflection");
var LangiumGrammarAstReflection = _LangiumGrammarAstReflection;
...
var _RegExpParser = class _RegExpParser {
  constructor() {
    this.idx = 0;
    this.input = "";
    this.groupIdx = 0;
...
__name(_RegExpParser, "RegExpParser");
var RegExpParser = _RegExpParser;

// ../../node_modules/@chevrotain/regexp-to-ast/lib/src/base-regexp-visitor.js
var _BaseRegExpVisitor = class _BaseRegExpVisitor {
  visitChildren(node) {
...
__name(_BaseRegExpVisitor, "BaseRegExpVisitor");
var BaseRegExpVisitor = _BaseRegExpVisitor;

// ../../node_modules/langium/lib/utils/regexp-utils.js
var NEWLINE_REGEXP = /\r?\n/gm;
var regexpParser = new RegExpParser();
var _TerminalRegExpVisitor = class _TerminalRegExpVisitor extends BaseRegExpVisitor {
  constructor() {
    super(...arguments);
...
__name(_TerminalRegExpVisitor, "TerminalRegExpVisitor");
var TerminalRegExpVisitor = _TerminalRegExpVisitor;
...
var _AbstractProduction = class _AbstractProduction {
  get definition() {
...
__name(_AbstractProduction, "AbstractProduction");
var AbstractProduction = _AbstractProduction;
var _NonTerminal = class _NonTerminal extends AbstractProduction {
  constructor(options) {
    super([]);
    this.idx = 1;
...
__name(_NonTerminal, "NonTerminal");
var NonTerminal = _NonTerminal;
var _Rule = class _Rule extends AbstractProduction {
  constructor(options) {
...
__name(_Rule, "Rule");
var Rule = _Rule;
var _Alternative = class _Alternative extends AbstractProduction {
  constructor(options) {
    super(options.definition);
...
__name(_Alternative, "Alternative");
var Alternative = _Alternative;
var _Option = class _Option extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
...
var Option = _Option;
var _RepetitionMandatory = class _RepetitionMandatory extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
...
__name(_RepetitionMandatory, "RepetitionMandatory");
var RepetitionMandatory = _RepetitionMandatory;
var _RepetitionMandatoryWithSeparator = class _RepetitionMandatoryWithSeparator extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
...
__name(_RepetitionMandatoryWithSeparator, "RepetitionMandatoryWithSeparator");
var RepetitionMandatoryWithSeparator = _RepetitionMandatoryWithSeparator;
var _Repetition = class _Repetition extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
...
__name(_Repetition, "Repetition");
var Repetition = _Repetition;
var _RepetitionWithSeparator = class _RepetitionWithSeparator extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
...
__name(_RepetitionWithSeparator, "RepetitionWithSeparator");
var RepetitionWithSeparator = _RepetitionWithSeparator;
var _Alternation = class _Alternation extends AbstractProduction {
  get definition() {
    return this._definition;
  }
  set definition(value) {
...
__name(_Alternation, "Alternation");
...
var _GAstVisitor = class _GAstVisitor {
  visit(node) {
    const nodeAny = node;
...
__name(_GAstVisitor, "GAstVisitor");
var GAstVisitor = _GAstVisitor;
...
var _RestWalker = class _RestWalker {
  walk(prod, prevRest = []) {
...
__name(_RestWalker, "RestWalker");
var RestWalker = _RestWalker;
...
var _ResyncFollowsWalker = class _ResyncFollowsWalker extends RestWalker {
  constructor(topProd) {
    super();
...
__name(_ResyncFollowsWalker, "ResyncFollowsWalker");
var ResyncFollowsWalker = _ResyncFollowsWalker;
...
var _CharCodeFinder = class _CharCodeFinder extends BaseRegExpVisitor {
...
__name(_CharCodeFinder, "CharCodeFinder");
var CharCodeFinder = _CharCodeFinder;
...
function findEndOfInputAnchor(tokenTypes) {
  const _EndAnchorFinder = class _EndAnchorFinder extends BaseRegExpVisitor {
    constructor() {
      super(...arguments);
      this.found = false;
    }
  ...
  __name(_EndAnchorFinder, "EndAnchorFinder");
  let EndAnchorFinder = _EndAnchorFinder;
...
function findStartOfInputAnchor(tokenTypes) {
  const _StartAnchorFinder = class _StartAnchorFinder extends BaseRegExpVisitor {
    constructor() {
      super(...arguments);
      this.found = false;
    }
  ...
  __name(_StartAnchorFinder, "StartAnchorFinder");
  let StartAnchorFinder = _StartAnchorFinder;
  const invalidRegex = filter_default(tokenTypes, (currType) => {
    const pattern = currType.PATTERN;
    try {
      const regexpAst = getRegExpAst(pattern);
...
var _GastRefResolverVisitor = class _GastRefResolverVisitor extends GAstVisitor {
...
__name(_GastRefResolverVisitor, "GastRefResolverVisitor");
var GastRefResolverVisitor = _GastRefResolverVisitor;

// ../../node_modules/chevrotain/lib/src/parse/grammar/interpreter.js
var _AbstractNextPossibleTokensWalker = class _AbstractNextPossibleTokensWalker extends RestWalker {
...
__name(_AbstractNextPossibleTokensWalker, "AbstractNextPossibleTokensWalker");
var AbstractNextPossibleTokensWalker = _AbstractNextPossibleTokensWalker;
var _NextAfterTokenWalker = class _NextAfterTokenWalker extends AbstractNextPossibleTokensWalker {
  constructor(topProd, path) {
    super(topProd, path);
    this.path = path;
...
__name(_NextAfterTokenWalker, "NextAfterTokenWalker");
var NextAfterTokenWalker = _NextAfterTokenWalker;
var _AbstractNextTerminalAfterProductionWalker = class _AbstractNextTerminalAfterProductionWalker extends RestWalker {
...
__name(_AbstractNextTerminalAfterProductionWalker, "AbstractNextTerminalAfterProductionWalker");
var AbstractNextTerminalAfterProductionWalker = _AbstractNextTerminalAfterProductionWalker;
var _NextTerminalAfterManyWalker = class _NextTerminalAfterManyWalker extends AbstractNextTerminalAfterProductionWalker {
  walkMany(manyProd, currRest, prevRest) {
...
__name(_NextTerminalAfterManyWalker, "NextTerminalAfterManyWalker");
var NextTerminalAfterManyWalker = _NextTerminalAfterManyWalker;
var _NextTerminalAfterManySepWalker = class _NextTerminalAfterManySepWalker extends AbstractNextTerminalAfterProductionWalker {
  walkManySep(manySepProd, currRest, prevRest) {
...
__name(_NextTerminalAfterManySepWalker, "NextTerminalAfterManySepWalker");
var NextTerminalAfterManySepWalker = _NextTerminalAfterManySepWalker;
var _NextTerminalAfterAtLeastOneWalker = class _NextTerminalAfterAtLeastOneWalker extends AbstractNextTerminalAfterProductionWalker {
  walkAtLeastOne(atLeastOneProd, currRest, prevRest) {
...
__name(_NextTerminalAfterAtLeastOneWalker, "NextTerminalAfterAtLeastOneWalker");
var NextTerminalAfterAtLeastOneWalker = _NextTerminalAfterAtLeastOneWalker;
var _NextTerminalAfterAtLeastOneSepWalker = class _NextTerminalAfterAtLeastOneSepWalker extends AbstractNextTerminalAfterProductionWalker {
  walkAtLeastOneSep(atleastOneSepProd, currRest, prevRest) {
...
__name(_NextTerminalAfterAtLeastOneSepWalker, "NextTerminalAfterAtLeastOneSepWalker");
var NextTerminalAfterAtLeastOneSepWalker = _NextTerminalAfterAtLeastOneSepWalker;
...
var _RestDefinitionFinderWalker = class _RestDefinitionFinderWalker extends RestWalker {
...
__name(_RestDefinitionFinderWalker, "RestDefinitionFinderWalker");
var RestDefinitionFinderWalker = _RestDefinitionFinderWalker;
var _InsideDefinitionFinderVisitor = class _InsideDefinitionFinderVisitor extends GAstVisitor {
...
__name(_InsideDefinitionFinderVisitor, "InsideDefinitionFinderVisitor");
var InsideDefinitionFinderVisitor = _InsideDefinitionFinderVisitor;
...
var _OccurrenceValidationCollector = class _OccurrenceValidationCollector extends GAstVisitor {
  constructor() {
    super(...arguments);
    this.allProductions = [];
  }
...
__name(_OccurrenceValidationCollector, "OccurrenceValidationCollector");
var OccurrenceValidationCollector = _OccurrenceValidationCollector;
...
var _OrCollector = class _OrCollector extends GAstVisitor {
  constructor() {
    super(...arguments);
    this.alternations = [];
  }
...
__name(_OrCollector, "OrCollector");
var OrCollector = _OrCollector;
...
var _RepetitionCollector = class _RepetitionCollector extends GAstVisitor {
  constructor() {
    super(...arguments);
    this.allProductions = [];
  }
...
__name(_RepetitionCollector, "RepetitionCollector");
var RepetitionCollector = _RepetitionCollector;
...
var _RecognitionException = class _RecognitionException extends Error {
...
__name(_RecognitionException, "RecognitionException");
var RecognitionException = _RecognitionException;
var _MismatchedTokenException = class _MismatchedTokenException extends RecognitionException {
...
__name(_MismatchedTokenException, "MismatchedTokenException");
var MismatchedTokenException = _MismatchedTokenException;
var _NoViableAltException = class _NoViableAltException extends RecognitionException {
  constructor(message, token, previousToken) {
    super(message, token);
    this.previousToken = previousToken;
...
__name(_NoViableAltException, "NoViableAltException");
var NoViableAltException = _NoViableAltException;
var _NotAllInputParsedException = class _NotAllInputParsedException extends RecognitionException {
  constructor(message, token) {
    super(message, token);
    this.name = NOT_ALL_INPUT_PARSED_EXCEPTION;
  }
};
__name(_NotAllInputParsedException, "NotAllInputParsedException");
var NotAllInputParsedException = _NotAllInputParsedException;
var _EarlyExitException = class _EarlyExitException extends RecognitionException {
  constructor(message, token, previousToken) {
    super(message, token);
    this.previousToken = previousToken;
...
__name(_EarlyExitException, "EarlyExitException");
var EarlyExitException = _EarlyExitException;

// ../../node_modules/chevrotain/lib/src/parse/parser/traits/recoverable.js
var EOF_FOLLOW_KEY = {};
var IN_RULE_RECOVERY_EXCEPTION = "InRuleRecoveryException";
var _InRuleRecoveryException = class _InRuleRecoveryException extends Error {
  constructor(message) {
    super(message);
    this.name = IN_RULE_RECOVERY_EXCEPTION;
  }
};
__name(_InRuleRecoveryException, "InRuleRecoveryException");
var InRuleRecoveryException = _InRuleRecoveryException;
var _Recoverable = class _Recoverable {
...
__name(_Recoverable, "Recoverable");
var Recoverable = _Recoverable;
...
var _LLkLookaheadStrategy = class _LLkLookaheadStrategy {
  constructor(options) {
    var _a6;
...
__name(_LLkLookaheadStrategy, "LLkLookaheadStrategy");
var LLkLookaheadStrategy = _LLkLookaheadStrategy;

// ../../node_modules/chevrotain/lib/src/parse/parser/traits/looksahead.js
var _LooksAhead = class _LooksAhead {
...
__name(_LooksAhead, "LooksAhead");
var LooksAhead = _LooksAhead;
var _DslMethodsCollectorVisitor = class _DslMethodsCollectorVisitor extends GAstVisitor {
  constructor() {
    super(...arguments);
    this.dslMethods = {
      option: [],
...
__name(_DslMethodsCollectorVisitor, "DslMethodsCollectorVisitor");
var DslMethodsCollectorVisitor = _DslMethodsCollectorVisitor;
...
__name(_TreeBuilder, "TreeBuilder");
var TreeBuilder = _TreeBuilder;

// ../../node_modules/chevrotain/lib/src/parse/parser/traits/lexer_adapter.js
var _LexerAdapter = class _LexerAdapter {
  initLexerAdapter() {
    this.tokVector = [];
...
__name(_LexerAdapter, "LexerAdapter");
var LexerAdapter = _LexerAdapter;

// ../../node_modules/chevrotain/lib/src/parse/parser/traits/recognizer_api.js
var _RecognizerApi = class _RecognizerApi {
  ACTION(impl) {
...
__name(_RecognizerApi, "RecognizerApi");
var RecognizerApi = _RecognizerApi;

// ../../node_modules/chevrotain/lib/src/parse/parser/traits/recognizer_engine.js
var _RecognizerEngine = class _RecognizerEngine {
...
__name(_RecognizerEngine, "RecognizerEngine");
var RecognizerEngine = _RecognizerEngine;
...
var _ContentAssist = class _ContentAssist {
  initContentAssist() {
  }
...
__name(_ContentAssist, "ContentAssist");
var ContentAssist = _ContentAssist;
...
var _GastRecorder = class _GastRecorder {
...
__name(_GastRecorder, "GastRecorder");
var GastRecorder = _GastRecorder;
...
var _PerformanceTracer = class _PerformanceTracer {
...
__name(_PerformanceTracer, "PerformanceTracer");
var PerformanceTracer = _PerformanceTracer;
...
var _EmbeddedActionsParser = class _EmbeddedActionsParser extends Parser {
...
__name(_EmbeddedActionsParser, "EmbeddedActionsParser");
var EmbeddedActionsParser = _EmbeddedActionsParser;
...
var ATN_LOOP_END = 12;
var _AbstractTransition = class _AbstractTransition {
  constructor(target) {
    this.target = target;
  }
  isEpsilon() {
...
__name(_AbstractTransition, "AbstractTransition");
var AbstractTransition = _AbstractTransition;
var _AtomTransition = class _AtomTransition extends AbstractTransition {
  constructor(target, tokenType) {
    super(target);
    this.tokenType = tokenType;
  }
};
__name(_AtomTransition, "AtomTransition");
var AtomTransition = _AtomTransition;
var _EpsilonTransition = class _EpsilonTransition extends AbstractTransition {
  constructor(target) {
    super(target);
  }
  isEpsilon() {
...
__name(_EpsilonTransition, "EpsilonTransition");
var EpsilonTransition = _EpsilonTransition;
var _RuleTransition = class _RuleTransition extends AbstractTransition {
...
__name(_RuleTransition, "RuleTransition");
var RuleTransition = _RuleTransition;
...
var DFA_ERROR = {};
var _ATNConfigSet = class _ATNConfigSet {
  constructor() {
    this.map = {};
    this.configs = [];
  }
...
__name(_ATNConfigSet, "ATNConfigSet");
var ATNConfigSet = _ATNConfigSet;
...
var _PredicateSet = class _PredicateSet {
  constructor() {
    this.predicates = [];
  }
  is(index) {
...
__name(_PredicateSet, "PredicateSet");
var PredicateSet = _PredicateSet;
var EMPTY_PREDICATES = new PredicateSet();
var _LLStarLookaheadStrategy = class _LLStarLookaheadStrategy extends LLkLookaheadStrategy {
  constructor(options) {
    var _a6;
    super();
...
__name(_LLStarLookaheadStrategy, "LLStarLookaheadStrategy");
var LLStarLookaheadStrategy = _LLStarLookaheadStrategy;
...
var FullTextDocument = _FullTextDocument;
var Is;
(function(Is2) {
...
var _CstNodeBuilder = class _CstNodeBuilder {
  constructor() {
    this.nodeStack = [];
  }
  get current() {
...
__name(_CstNodeBuilder, "CstNodeBuilder");
var CstNodeBuilder = _CstNodeBuilder;
var _AbstractCstNode = class _AbstractCstNode {
...
__name(_AbstractCstNode, "AbstractCstNode");
var AbstractCstNode = _AbstractCstNode;
var _LeafCstNodeImpl = class _LeafCstNodeImpl extends AbstractCstNode {
  get offset() {
    return this._offset;
  }
  get length() {
...
__name(_LeafCstNodeImpl, "LeafCstNodeImpl");
var LeafCstNodeImpl = _LeafCstNodeImpl;
var _CompositeCstNodeImpl = class _CompositeCstNodeImpl extends AbstractCstNode {
  constructor() {
    super(...arguments);
...
__name(_CompositeCstNodeImpl, "CompositeCstNodeImpl");
var CompositeCstNodeImpl = _CompositeCstNodeImpl;
var _CstNodeContainer = class _CstNodeContainer extends Array {
  constructor(parent) {
    super();
    this.parent = parent;
...
__name(_CstNodeContainer, "CstNodeContainer");
var CstNodeContainer = _CstNodeContainer;
var _RootCstNodeImpl = class _RootCstNodeImpl extends CompositeCstNodeImpl {
  get text() {
...
__name(_RootCstNodeImpl, "RootCstNodeImpl");
var RootCstNodeImpl = _RootCstNodeImpl;
...
var _AbstractLangiumParser = class _AbstractLangiumParser {
...
__name(_AbstractLangiumParser, "AbstractLangiumParser");
var AbstractLangiumParser = _AbstractLangiumParser;
var _LangiumParser = class _LangiumParser extends AbstractLangiumParser {
  get current() {
...
__name(_LangiumParser, "LangiumParser");
var LangiumParser = _LangiumParser;
var _AbstractParserErrorMessageProvider = class _AbstractParserErrorMessageProvider {
...
__name(_AbstractParserErrorMessageProvider, "AbstractParserErrorMessageProvider");
var AbstractParserErrorMessageProvider = _AbstractParserErrorMessageProvider;
var _LangiumParserErrorMessageProvider = class _LangiumParserErrorMessageProvider extends AbstractParserErrorMessageProvider {
...
__name(_LangiumParserErrorMessageProvider, "LangiumParserErrorMessageProvider");
var LangiumParserErrorMessageProvider = _LangiumParserErrorMessageProvider;
var _LangiumCompletionParser = class _LangiumCompletionParser extends AbstractLangiumParser {
  constructor() {
    super(...arguments);
    this.tokens = [];
    this.elementStack = [];
...
__name(_LangiumCompletionParser, "LangiumCompletionParser");
var LangiumCompletionParser = _LangiumCompletionParser;
var defaultConfig = {
  recoveryEnabled: true,
...
var _ChevrotainWrapper = class _ChevrotainWrapper extends EmbeddedActionsParser {
...
__name(_ChevrotainWrapper, "ChevrotainWrapper");
var ChevrotainWrapper = _ChevrotainWrapper;
...
var _DefaultTokenBuilder = class _DefaultTokenBuilder {
  constructor() {
    this.diagnostics = [];
  }
...
__name(_DefaultTokenBuilder, "DefaultTokenBuilder");
var DefaultTokenBuilder = _DefaultTokenBuilder;

// ../../node_modules/langium/lib/parser/value-converter.js
var _DefaultValueConverter = class _DefaultValueConverter {
...
__name(_DefaultValueConverter, "DefaultValueConverter");
var DefaultValueConverter = _DefaultValueConverter;
var ValueConverter;
...
var _FullTextDocument2 = class _FullTextDocument2 {
  constructor(uri, languageId, version, content) {
    this._uri = uri;
    this._languageId = languageId;
    this._version = version;
  ...
  update(changes, version) {
    for (const change of changes) {
      if (_FullTextDocument2.isIncremental(change)) {
      ...
      } else if (_FullTextDocument2.isFull(change)) {
...
__name(_FullTextDocument2, "FullTextDocument");
var FullTextDocument2 = _FullTextDocument2;
var TextDocument2;
(function(TextDocument3) {
  function create(uri, languageId, version, content) {
...
(() => {
  ...
  (() => {
    ...
    const _f = class _f {
      static isUri(t3) {
        return t3 instanceof _f || !!t3 && "string" == typeof t3.authority && "string" == typeof t3.fragment && "string" == typeof t3.path && "string" == typeof t3.query && "string" == typeof t3.scheme && "string" == typeof t3.fsPath && "function" == typeof t3.with && "function" == typeof t3.toString;
      }
      scheme;
      authority;
      path;
...
var _DefaultLangiumDocumentFactory = class _DefaultLangiumDocumentFactory {
  constructor(services) {
...
__name(_DefaultLangiumDocumentFactory, "DefaultLangiumDocumentFactory");
var DefaultLangiumDocumentFactory = _DefaultLangiumDocumentFactory;
var _DefaultLangiumDocuments = class _DefaultLangiumDocuments {
  constructor(services) {
...
__name(_DefaultLangiumDocuments, "DefaultLangiumDocuments");
var DefaultLangiumDocuments = _DefaultLangiumDocuments;

// ../../node_modules/langium/lib/references/linker.js
var ref_resolving = Symbol("ref_resolving");
var _DefaultLinker = class _DefaultLinker {
  constructor(services) {
...
__name(_DefaultLinker, "DefaultLinker");
var DefaultLinker = _DefaultLinker;
...
var _DefaultNameProvider = class _DefaultNameProvider {
  getName(node) {
    if (isNamed(node)) {
      return node.name;
    }
...
__name(_DefaultNameProvider, "DefaultNameProvider");
var DefaultNameProvider = _DefaultNameProvider;

// ../../node_modules/langium/lib/references/references.js
var _DefaultReferences = class _DefaultReferences {
  constructor(services) {
...
__name(_DefaultReferences, "DefaultReferences");
var DefaultReferences = _DefaultReferences;

// ../../node_modules/langium/lib/utils/collections.js
var _MultiMap = class _MultiMap {
...
__name(_MultiMap, "MultiMap");
var MultiMap = _MultiMap;
var _BiMap = class _BiMap {
  get size() {
...
var _DefaultScopeComputation = class _DefaultScopeComputation {
  constructor(services) {
    this.nameProvider = services.references.NameProvider;
...
__name(_DefaultScopeComputation, "DefaultScopeComputation");
var DefaultScopeComputation = _DefaultScopeComputation;

// ../../node_modules/langium/lib/references/scope.js
var _StreamScope = class _StreamScope {
...
__name(_StreamScope, "StreamScope");
var StreamScope = _StreamScope;
var _MapScope = class _MapScope {
  constructor(elements, outerScope, options) {
    var _a6;
...
__name(_MapScope, "MapScope");
var MapScope = _MapScope;
var EMPTY_SCOPE = {
  getElement() {
    return void 0;
  },
...
var _DisposableCache = class _DisposableCache {
  constructor() {
    this.toDispose = [];
...
__name(_DisposableCache, "DisposableCache");
var DisposableCache = _DisposableCache;
var _SimpleCache = class _SimpleCache extends DisposableCache {
  constructor() {
    super(...arguments);
...
__name(_SimpleCache, "SimpleCache");
var SimpleCache = _SimpleCache;
var _ContextCache = class _ContextCache extends DisposableCache {
...
var ContextCache = _ContextCache;
var _DocumentCache = class _DocumentCache extends ContextCache {
  /**
...
__name(_DocumentCache, "DocumentCache");
var DocumentCache = _DocumentCache;
var _WorkspaceCache = class _WorkspaceCache extends SimpleCache {
  /**
...
__name(_WorkspaceCache, "WorkspaceCache");
var WorkspaceCache = _WorkspaceCache;

// ../../node_modules/langium/lib/references/scope-provider.js
var _DefaultScopeProvider = class _DefaultScopeProvider {
  constructor(services) {
    this.reflection = services.shared.AstReflection;
    this.nameProvider = services.references.NameProvider;
    this.descriptions = services.workspace.AstNodeDescriptionProvider;
...
__name(_DefaultScopeProvider, "DefaultScopeProvider");
var DefaultScopeProvider = _DefaultScopeProvider;
...
var _DefaultJsonSerializer = class _DefaultJsonSerializer {
  constructor(services) {
...
__name(_DefaultJsonSerializer, "DefaultJsonSerializer");
var DefaultJsonSerializer = _DefaultJsonSerializer;

// ../../node_modules/langium/lib/service-registry.js
var _DefaultServiceRegistry = class _DefaultServiceRegistry {
  /**
...
__name(_DefaultServiceRegistry, "DefaultServiceRegistry");
var DefaultServiceRegistry = _DefaultServiceRegistry;
...
var _ValidationRegistry = class _ValidationRegistry {
  constructor(services) {
...
__name(_ValidationRegistry, "ValidationRegistry");
var ValidationRegistry = _ValidationRegistry;

// ../../node_modules/langium/lib/validation/document-validator.js
var _DefaultDocumentValidator = class _DefaultDocumentValidator {
  constructor(services) {
...
__name(_DefaultDocumentValidator, "DefaultDocumentValidator");
var DefaultDocumentValidator = _DefaultDocumentValidator;
...
var _DefaultAstNodeDescriptionProvider = class _DefaultAstNodeDescriptionProvider {
  constructor(services) {
    this.astNodeLocator = services.workspace.AstNodeLocator;
    this.nameProvider = services.references.NameProvider;
  }
...
__name(_DefaultAstNodeDescriptionProvider, "DefaultAstNodeDescriptionProvider");
var DefaultAstNodeDescriptionProvider = _DefaultAstNodeDescriptionProvider;
var _DefaultReferenceDescriptionProvider = class _DefaultReferenceDescriptionProvider {
  constructor(services) {
    this.nodeLocator = services.workspace.AstNodeLocator;
  }
...
__name(_DefaultReferenceDescriptionProvider, "DefaultReferenceDescriptionProvider");
var DefaultReferenceDescriptionProvider = _DefaultReferenceDescriptionProvider;

// ../../node_modules/langium/lib/workspace/ast-node-locator.js
var _DefaultAstNodeLocator = class _DefaultAstNodeLocator {
  constructor() {
...
__name(_DefaultAstNodeLocator, "DefaultAstNodeLocator");
var DefaultAstNodeLocator = _DefaultAstNodeLocator;
...
var _DefaultConfigurationProvider = class _DefaultConfigurationProvider {
  constructor(services) {
...
__name(_DefaultConfigurationProvider, "DefaultConfigurationProvider");
var DefaultConfigurationProvider = _DefaultConfigurationProvider;
...
var _DefaultDocumentBuilder = class _DefaultDocumentBuilder {
  constructor(services) {
...
__name(_DefaultDocumentBuilder, "DefaultDocumentBuilder");
var DefaultDocumentBuilder = _DefaultDocumentBuilder;

// ../../node_modules/langium/lib/workspace/index-manager.js
var _DefaultIndexManager = class _DefaultIndexManager {
  constructor(services) {
...
__name(_DefaultIndexManager, "DefaultIndexManager");
var DefaultIndexManager = _DefaultIndexManager;

// ../../node_modules/langium/lib/workspace/workspace-manager.js
var _DefaultWorkspaceManager = class _DefaultWorkspaceManager {
  constructor(services) {
...
__name(_DefaultWorkspaceManager, "DefaultWorkspaceManager");
var DefaultWorkspaceManager = _DefaultWorkspaceManager;

// ../../node_modules/langium/lib/parser/lexer.js
var _DefaultLexerErrorMessageProvider = class _DefaultLexerErrorMessageProvider {
  buildUnexpectedCharactersMessage(fullText, startOffset, length, line, column) {
...
__name(_DefaultLexerErrorMessageProvider, "DefaultLexerErrorMessageProvider");
var DefaultLexerErrorMessageProvider = _DefaultLexerErrorMessageProvider;
var DEFAULT_TOKENIZE_OPTIONS = { mode: "full" };
var _DefaultLexer = class _DefaultLexer {
  constructor(services) {
...
__name(_DefaultLexer, "DefaultLexer");
var DefaultLexer = _DefaultLexer;
...
var _JSDocCommentImpl = class _JSDocCommentImpl {
...
__name(_JSDocCommentImpl, "JSDocCommentImpl");
var JSDocCommentImpl = _JSDocCommentImpl;
var _JSDocTagImpl = class _JSDocTagImpl {
...
__name(_JSDocTagImpl, "JSDocTagImpl");
var JSDocTagImpl = _JSDocTagImpl;
...
var _JSDocTextImpl = class _JSDocTextImpl {
...
__name(_JSDocTextImpl, "JSDocTextImpl");
var JSDocTextImpl = _JSDocTextImpl;
var _JSDocLineImpl = class _JSDocLineImpl {
...
__name(_JSDocLineImpl, "JSDocLineImpl");
var JSDocLineImpl = _JSDocLineImpl;
...
var _JSDocDocumentationProvider = class _JSDocDocumentationProvider {
  constructor(services) {
    this.indexManager = services.shared.workspace.IndexManager;
    this.commentProvider = services.documentation.CommentProvider;
  }
...
__name(_JSDocDocumentationProvider, "JSDocDocumentationProvider");
var JSDocDocumentationProvider = _JSDocDocumentationProvider;

// ../../node_modules/langium/lib/documentation/comment-provider.js
var _DefaultCommentProvider = class _DefaultCommentProvider {
  constructor(services) {
...
__name(_DefaultCommentProvider, "DefaultCommentProvider");
var DefaultCommentProvider = _DefaultCommentProvider;

// ../../node_modules/langium/lib/parser/async-parser.js
var _DefaultAsyncParser = class _DefaultAsyncParser {
  constructor(services) {
...
__name(_DefaultAsyncParser, "DefaultAsyncParser");
var DefaultAsyncParser = _DefaultAsyncParser;
var _AbstractThreadedAsyncParser = class _AbstractThreadedAsyncParser {
  constructor(services) {
    this.threadCount = 8;
...
__name(_AbstractThreadedAsyncParser, "AbstractThreadedAsyncParser");
var AbstractThreadedAsyncParser = _AbstractThreadedAsyncParser;
var _ParserWorker = class _ParserWorker {
  get ready() {
    return this._ready;
  }
  get onReady() {
...
__name(_ParserWorker, "ParserWorker");
var ParserWorker = _ParserWorker;

// ../../node_modules/langium/lib/workspace/workspace-lock.js
var _DefaultWorkspaceLock = class _DefaultWorkspaceLock {
  constructor() {
...
__name(_DefaultWorkspaceLock, "DefaultWorkspaceLock");
var DefaultWorkspaceLock = _DefaultWorkspaceLock;

// ../../node_modules/langium/lib/serializer/hydrator.js
var _DefaultHydrator = class _DefaultHydrator {
  constructor(services) {
...
__name(_DefaultHydrator, "DefaultHydrator");
var DefaultHydrator = _DefaultHydrator;
...
var _IndentationAwareTokenBuilder = class _IndentationAwareTokenBuilder extends DefaultTokenBuilder {
...
__name(_IndentationAwareTokenBuilder, "IndentationAwareTokenBuilder");
var IndentationAwareTokenBuilder = _IndentationAwareTokenBuilder;
var _IndentationAwareLexer = class _IndentationAwareLexer extends DefaultLexer {
  constructor(services) {
    super(services);
...
__name(_IndentationAwareLexer, "IndentationAwareLexer");
var IndentationAwareLexer = _IndentationAwareLexer;
...
var _EmptyFileSystemProvider = class _EmptyFileSystemProvider {
  readFile() {
...
__name(_EmptyFileSystemProvider, "EmptyFileSystemProvider");
var EmptyFileSystemProvider = _EmptyFileSystemProvider;
var EmptyFileSystem = {
...
var MermaidGeneratedSharedModule = {
  AstReflection: __name2(() => new MermaidAstReflection(), "AstReflection")
};
var InfoGeneratedModule = {
  Grammar: __name2(() => InfoGrammar(), "Grammar"),
  LanguageMetaData: __name2(() => InfoLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var PacketGeneratedModule = {
  Grammar: __name2(() => PacketGrammar(), "Grammar"),
  LanguageMetaData: __name2(() => PacketLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var PieGeneratedModule = {
  Grammar: __name2(() => PieGrammar(), "Grammar"),
  LanguageMetaData: __name2(() => PieLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var ArchitectureGeneratedModule = {
  Grammar: __name2(() => ArchitectureGrammar(), "Grammar"),
  LanguageMetaData: __name2(() => ArchitectureLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var GitGraphGeneratedModule = {
  Grammar: __name2(() => GitGraphGrammar(), "Grammar"),
  LanguageMetaData: __name2(() => GitGraphLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var RadarGeneratedModule = {
  Grammar: __name2(() => RadarGrammar(), "Grammar"),
  LanguageMetaData: __name2(() => RadarLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var TreemapGeneratedModule = {
  Grammar: __name2(() => TreemapGrammar(), "Grammar"),
  LanguageMetaData: __name2(() => TreemapLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
...
}, __name(_a2, "AbstractMermaidValueConverter"), __name2(_a2, "AbstractMermaidValueConverter"), _a2);
var _a3;
var CommonValueConverter = (_a3 = class extends AbstractMermaidValueConverter {
  runCustomConverter(_rule, _input, _cstNode) {
    return void 0;
  }
}, __name(_a3, "CommonValueConverter"), __name2(_a3, "CommonValueConverter"), _a3);
var _a4;
...
}, __name(_a4, "AbstractMermaidTokenBuilder"), __name2(_a4, "AbstractMermaidTokenBuilder"), _a4);
var _a5;
var CommonTokenBuilder = (_a5 = class extends AbstractMermaidTokenBuilder {
}, __name(_a5, "CommonTokenBuilder"), __name2(_a5, "CommonTokenBuilder"), _a5);
...
//# sourceMappingURL=chunk-KK6H3XHX.js.map
