...
}, __name(_a, "ClassMember"), __name2(_a, "ClassMember"), _a);
var MERMAID_DOM_ID_PREFIX = "classId-";
var classCounter = 0;
var sanitizeText2 = __name2((txt) => common_default.sanitizeText(txt, getConfig2()), "sanitizeText");
var _a2;
var ClassDB = (_a2 = class {
  constructor() {
    ...
    this.setupToolTips = __name2((element) => {
    ...
    this.getConfig = __name2(() => getConfig2().class, "getConfig");
...
}, __name(_a2, "ClassDB"), __name2(_a2, "ClassDB"), _a2);
var getStyles = __name2((options) => `g.classGroup text {
...
var getDir = __name2((parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
//# sourceMappingURL=chunk-KWRP6QQV.js.map
