...
var registerIconPacks = __name2((iconLoaders) => {
...
var getRegisteredIconData = __name2(async (iconName, fallbackPrefix) => {
...
var isIconAvailable = __name2(async (iconName) => {
  try {
...
var getIconSVG = __name2(async (iconName, customisations, extraAttributes) => {
  let iconData;
  try {
...
function markdownToLines(markdown, config = {}) {
  ...
  __name2(processNode, "processNode");
...
__name2(markdownToLines, "markdownToLines");
...
__name2(splitTextToChars, "splitTextToChars");
function splitWordToFitWidth(checkFit, word) {
  const characters = splitTextToChars(word.content);
  return splitWordToFitWidthRecursion(checkFit, [], characters, word.type);
}
__name(splitWordToFitWidth, "splitWordToFitWidth");
__name2(splitWordToFitWidth, "splitWordToFitWidth");
...
__name2(splitWordToFitWidthRecursion, "splitWordToFitWidthRecursion");
...
__name2(splitLineToFitWidth, "splitLineToFitWidth");
...
__name2(splitLineToFitWidthRecursion, "splitLineToFitWidthRecursion");
...
__name2(addHtmlSpan, "addHtmlSpan");
function createTspan(textElement, lineIndex, lineHeight) {
  return textElement.append("tspan").attr("class", "text-outer-tspan").attr("x", 0).attr("y", lineIndex * lineHeight - 0.1 + "em").attr("dy", lineHeight + "em");
}
__name(createTspan, "createTspan");
__name2(createTspan, "createTspan");
...
__name2(computeWidthOfText, "computeWidthOfText");
...
__name2(computeDimensionOfText, "computeDimensionOfText");
function createFormattedText(width, g, structuredText, addBackground = false) {
  ...
  for (const line of structuredText) {
    const checkWidth = __name2((line2) => computeWidthOfText(labelGroup, lineHeight, line2) <= width, "checkWidth");
...
__name2(createFormattedText, "createFormattedText");
...
__name2(updateTextContentAndStyles, "updateTextContentAndStyles");
...
__name2(replaceIconSubstring, "replaceIconSubstring");
var createText = __name2(async (el, text = "", {
  style = "",
  isTitle = false,
  classes = "",
  useHtmlLabels = true,
...
//# sourceMappingURL=chunk-MAYWSMMN.js.map
