...
var labelHelper = __name2(async (parent, node, _classes) => {
  let cssClasses;
...
var insertLabel = __name2(async (parent, label, options) => {
...
var getNodeClasses = __name2((node, extra) => (node.look === "handDrawn" ? "rough-node" : "node") + " " + node.cssClasses + " " + (extra || ""), "getNodeClasses");
...
__name2(createPathFromPoints, "createPathFromPoints");
...
__name2(generateFullSineWavePoints, "generateFullSineWavePoints");
...
__name2(generateCirclePoints, "generateCirclePoints");
var intersectRect = __name2((node, point) => {
  var x2 = node.x;
  var y2 = node.y;
  var dx = point.x - x2;
  var dy = point.y - y2;
...
var createRoundedRectPathD = __name2((x2, y2, totalWidth, totalHeight, radius) => [
  "M",
  x2 + radius,
  y2,
...
var noteGroup = __name2((parent, node) => {
...
var roundedWithTitle = __name2(async (parent, node) => {
  const siteConfig = getConfig2();
  const { themeVariables, handDrawnSeed } = siteConfig;
...
var kanbanSection = __name2(async (parent, node) => {
  log.info("Creating subgraph rect for ", node.id, node);
  const siteConfig = getConfig2();
  const { themeVariables, handDrawnSeed } = siteConfig;
  const { clusterBkg, clusterBorder } = themeVariables;
...
var divider = __name2((parent, node) => {
  const siteConfig = getConfig2();
  const { themeVariables, handDrawnSeed } = siteConfig;
...
var insertCluster = __name2(async (elem, node) => {
...
__name2(generateArcPoints, "generateArcPoints");
...
__name2(crossedCircle, "crossedCircle");
...
__name(generateCirclePoints2, "generateCirclePoints2");
__name2(generateCirclePoints2, "generateCirclePoints");
...
__name2(curlyBraceLeft, "curlyBraceLeft");
...
__name(generateCirclePoints3, "generateCirclePoints3");
__name2(generateCirclePoints3, "generateCirclePoints");
...
__name2(curlyBraceRight, "curlyBraceRight");
...
__name(generateCirclePoints4, "generateCirclePoints4");
__name2(generateCirclePoints4, "generateCirclePoints");
...
__name2(curlyBraces, "curlyBraces");
...
__name2(curvedTrapezoid, "curvedTrapezoid");
var createCylinderPathD = __name2((x2, y2, width, height, rx, ry) => {
  return [
    `M${x2},${y2 + ry}`,
...
var createOuterCylinderPathD = __name2((x2, y2, width, height, rx, ry) => {
  return [
    `M${x2},${y2 + ry}`,
    `M${x2 + width},${y2 + ry}`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createInnerCylinderPathD = __name2((x2, y2, width, height, rx, ry) => {
...
__name2(dividedRectangle, "dividedRectangle");
...
__name2(doublecircle, "doublecircle");
...
__name2(filledCircle, "filledCircle");
...
__name2(flippedTriangle, "flippedTriangle");
...
__name2(halfRoundedRectangle, "halfRoundedRectangle");
...
__name2(iconRounded, "iconRounded");
...
__name2(imageSquare, "imageSquare");
...
__name2(inv_trapezoid, "inv_trapezoid");
...
__name2(lightningBolt, "lightningBolt");
var createCylinderPathD2 = __name2((x2, y2, width, height, rx, ry, outerOffset) => {
  return [
    `M${x2},${y2 + ry}`,
    `a${rx},${ry} 0,0,0 ${width},0`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createOuterCylinderPathD2 = __name2((x2, y2, width, height, rx, ry, outerOffset) => {
  return [
    `M${x2},${y2 + ry}`,
    `M${x2 + width},${y2 + ry}`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createInnerCylinderPathD2 = __name2((x2, y2, width, height, rx, ry) => {
  return [`M${x2 - width / 2},${-height / 2}`, `a${rx},${ry} 0,0,0 ${width},0`].join(" ");
}, "createInnerCylinderPathD");
...
__name2(linedCylinder, "linedCylinder");
...
__name2(linedWaveEdgedRect, "linedWaveEdgedRect");
...
__name2(multiWaveEdgedRectangle, "multiWaveEdgedRectangle");
...
__name(note, "note");
__name2(note, "note");
var createDecisionBoxPathD = __name2((x2, y2, size) => {
  return [
    `M${x2 + size / 2},${y2}`,
    `L${x2 + size},${y2 - size / 2}`,
    `L${x2 + size / 2},${y2 - size}`,
...
__name2(rect_left_inv_arrow, "rect_left_inv_arrow");
...
__name2(rectWithTitle, "rectWithTitle");
...
__name(generateArcPoints2, "generateArcPoints2");
__name2(generateArcPoints2, "generateArcPoints");
...
__name2(roundedRect, "roundedRect");
...
__name2(shadedProcess, "shadedProcess");
...
__name(squareRect2, "squareRect2");
__name2(squareRect2, "squareRect");
...
__name2(taggedWaveEdgedRectangle, "taggedWaveEdgedRectangle");
...
__name(text, "text");
__name2(text, "text");
var createCylinderPathD3 = __name2((x2, y2, width, height, rx, ry) => {
  return `M${x2},${y2}
...
var createOuterCylinderPathD3 = __name2((x2, y2, width, height, rx, ry) => {
  return [
    `M${x2},${y2}`,
    `M${x2 + width},${y2}`,
    `a${rx},${ry} 0,0,0 ${0},${-height}`,
...
var createInnerCylinderPathD3 = __name2((x2, y2, width, height, rx, ry) => {
...
__name2(tiltedCylinder, "tiltedCylinder");
...
__name2(trapezoidalPentagon, "trapezoidalPentagon");
...
__name2(waveEdgedRectangle, "waveEdgedRectangle");
...
__name2(waveRectangle, "waveRectangle");
...
__name(addText2, "addText2");
__name2(addText2, "addText");
...
__name2(requirementBox, "requirementBox");
...
__name(addText3, "addText3");
__name2(addText3, "addText");
var colorFromPriority = __name2((priority) => {
  switch (priority) {
    case "Very High":
      return "red";
    case "High":
...
__name2(defaultMindmapNode, "defaultMindmapNode");
...
__name2(mindmapCircle, "mindmapCircle");
var shapesDefs = [
  {
...
__name2(isValidShape, "isValidShape");
...
__name2(insertNode, "insertNode");
var setNodeElem = __name2((elem, node) => {
...
//# sourceMappingURL=chunk-OXJQOY5E.js.map
