...
function createMemoryHistory(options = {}) {
  ...
  __name(createHref2, "createHref2");
  let history = {
    get index() {
      return index;
    },
...
function generatePath(originalPath, params = {}) {
  ...
  const stringify2 = /* @__PURE__ */ __name((p) => p == null ? "" : typeof p === "string" ? p : String(p), "stringify2");
...
var _a2;
var DataWithResponseInit = (_a2 = class {
  constructor(data2, init) {
    this.type = "DataWithResponseInit";
    this.data = data2;
    this.init = init || null;
  }
}, __name(_a2, "DataWithResponseInit"), _a2);
...
var _a3;
var ErrorResponseImpl = (_a3 = class {
...
}, __name(_a3, "ErrorResponseImpl"), _a3);
...
var AwaitContextProvider = /* @__PURE__ */ __name((props) => React.createElement(AwaitContext.Provider, props), "AwaitContextProvider");
...
var _a4;
var RenderErrorBoundary = (_a4 = class extends React2.Component {
  constructor(props) {
    super(props);
    this.state = {
...
}, __name(_a4, "RenderErrorBoundary"), _a4);
...
function RouterProvider({
  ...
  let navigator = React3.useMemo(() => {
    return {
      ...
      go: /* @__PURE__ */ __name((n) => router.navigate(n), "go"),
      push: /* @__PURE__ */ __name((to, state2, opts) => router.navigate(to, {
        state: state2,
        preventScrollReset: opts?.preventScrollReset
      }), "push"),
      replace: /* @__PURE__ */ __name((to, state2, opts) => router.navigate(to, {
        replace: true,
        state: state2,
        preventScrollReset: opts?.preventScrollReset
      }), "replace")
...
__name(Await, "Await");
var _a6;
var AwaitErrorBoundary = (_a6 = class extends React3.Component {
  constructor(props) {
    super(props);
...
}, __name(_a6, "AwaitErrorBoundary"), _a6);
...
__name(useHydrateFallbackProps, "useHydrateFallbackProps");
...
__name(WithHydrateFallbackProps, "WithHydrateFallbackProps");
function withHydrateFallbackProps(HydrateFallback) {
  return /* @__PURE__ */ __name(function WithHydrateFallbackProps2() {
    const props = useHydrateFallbackProps();
...
var _a8;
var SingleFetchNoResultError = (_a8 = class extends Error {
}, __name(_a8, "SingleFetchNoResultError"), _a8);
...
__name(getTurboStreamSingleFetchDataStrategy, "getTurboStreamSingleFetchDataStrategy");
...
__name(getSingleFetchDataStrategyImpl, "getSingleFetchDataStrategyImpl");
...
__name(nonSsrStrategy, "nonSsrStrategy");
...
__name(bubbleMiddlewareErrors, "bubbleMiddlewareErrors");
...
__name(fetchAndDecodeViaTurboStream, "fetchAndDecodeViaTurboStream");
...
__name(createDeferred2, "createDeferred2");
...
__name(getRouteCssDescriptors, "getRouteCssDescriptors");
async function prefetchRouteCss(route) {
  if (!route.css) return;
  let descriptors = getRouteCssDescriptors(route);
  await Promise.all(descriptors.map(prefetchStyleLink));
}
__name(prefetchRouteCss, "prefetchRouteCss");
...
function createServerRoutes(manifest, routeModules, future, isSpaMode, parentId = "", routesByParentId = groupRoutesByParentId(manifest), spaModeLazyPromise = Promise.resolve({ Component: /* @__PURE__ */ __name(() => null, "Component") })) {
...
function createClientRoutes(manifest, routeModulesCache, initialState, ssr, isSpaMode, parentId = "", routesByParentId = groupRoutesByParentId(manifest), needsRevalidation) {
  return (routesByParentId[parentId] || []).map((route) => {
    ...
    __name(prefetchModule, "prefetchModule");
    ...
    __name(prefetchRouteModuleChunks, "prefetchRouteModuleChunks");
    ...
    if (routeModule) {
      ...
      __name(getLazyRoute, "getLazyRoute");
      dataRoute.lazy = {
        ...
        shouldRevalidate: /* @__PURE__ */ __name(async () => {
        ...
        handle: /* @__PURE__ */ __name(async () => (await getLazyRoute()).handle, "handle"),
        // No need to wrap these in layout since the root route is never
        // loaded via route.lazy()
        Component: /* @__PURE__ */ __name(async () => (await getLazyRoute()).Component, "Component"),
...
function getShouldRevalidateFunction(path, route, manifestRoute, ssr, needsRevalidation) {
  ...
  if (!ssr && manifestRoute.hasLoader && !manifestRoute.hasClientLoader) {
    ...
    const didParamsChange = /* @__PURE__ */ __name((opts) => myParams.some((p) => opts.currentParams[p] !== opts.nextParams[p]), "didParamsChange");
...
var _a9;
var RemixErrorBoundary = (_a9 = class extends React9.Component {
  constructor(props) {
    super(props);
...
}, __name(_a9, "RemixErrorBoundary"), _a9);
...
__name(createStaticHandler2, "createStaticHandler2");
...
function createRoutesStub(routes, _context) {
  return /* @__PURE__ */ __name(function RoutesTestStub({
    initialEntries,
    initialIndex,
    hydrationData,
    future
...
__name(createRoutesStub, "createRoutesStub");
...
__name(processRoutes, "processRoutes");
...
var unsign = /* @__PURE__ */ __name(async (cookie, secret) => {
...
var createKey2 = /* @__PURE__ */ __name(async (secret, usages) => crypto.subtle.importKey(
  "raw",
...
var createCookie = /* @__PURE__ */ __name((name, cookieOptions = {}) => {
  let { secrets = [], ...options } = {
    path: "/",
    sameSite: "lax",
    ...cookieOptions
...
__name(serializeErrors2, "serializeErrors");
...
__name(stripIndexParam2, "stripIndexParam");
...
__name(createSessionStorage, "createSessionStorage");
...
__name(createCookieSessionStorage, "createCookieSessionStorage");
...
function injectRSCPayload(rscStream) {
  ...
  __name(flushBufferedChunks, "flushBufferedChunks");
  return new TransformStream({
    transform(chunk, controller) {
      buffered.push(chunk);
      if (timeout) {
...
__name(injectRSCPayload, "injectRSCPayload");
...
__name(writeRSCStream, "writeRSCStream");
...
var _a10;
var RSCRouterGlobalErrorBoundary = (_a10 = class extends import_react.default.Component {
  constructor(props) {
    super(props);
...
}, __name(_a10, "RSCRouterGlobalErrorBoundary"), _a10);
...
__name(RSCDefaultRootErrorBoundary, "RSCDefaultRootErrorBoundary");
...
__name(createRSCRouteModules, "createRSCRouteModules");
...
__name(populateRSCRouteModules, "populateRSCRouteModules");
var noopComponent = /* @__PURE__ */ __name(() => null, "noopComponent");
var REACT_USE = "use";
...
async function routeRSCServerRequest({
  ...
  const getPayload = /* @__PURE__ */ __name(() => {
...
__name(routeRSCServerRequest, "routeRSCServerRequest");
...
__name(RSCStaticRouter, "RSCStaticRouter");
function isReactServerRequest(url) {
  return url.pathname.endsWith(".rsc");
}
__name(isReactServerRequest, "isReactServerRequest");
function isManifestRequest(url) {
  return url.pathname.endsWith(".manifest");
}
__name(isManifestRequest, "isManifestRequest");
...
__name(deserializeErrors2, "deserializeErrors");
...
__name(getHydrationData, "getHydrationData");
...
//# sourceMappingURL=chunk-YEET22RR.js.map
