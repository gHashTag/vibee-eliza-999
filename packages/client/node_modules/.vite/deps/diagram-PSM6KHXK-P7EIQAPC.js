...
}, __name(_a, "TreeMapDB"), __name2(_a, "TreeMapDB"), _a);
...
var populate = __name2((ast, db) => {
  ...
  const addNodesRecursively = __name2((nodes, level) => {
...
var getItemName = __name2((item) => {
  return item.name ? String(item.name) : "";
}, "getItemName");
var parser = {
  // @ts-expect-error - TreeMapDB is not assignable to DiagramDB
  parser: { yy: void 0 },
  parse: __name2(async (text) => {
    try {
...
var draw = __name2((_text, id, _version, diagram2) => {
  ...
  try {
    ...
    if (formatStr === "$0,0") {
      valueFormat = __name2((value) => "$" + format(",")(value), "valueFormat");
    } else if (formatStr.startsWith("$") && formatStr.includes(",")) {
      const precision = /\.\d+/.exec(formatStr);
      const precisionStr = precision ? precision[0] : "";
      valueFormat = __name2((value) => "$" + format("," + precisionStr)(value), "valueFormat");
    } else if (formatStr.startsWith("$")) {
      const restOfFormat = formatStr.substring(1);
      valueFormat = __name2((value) => "$" + format(restOfFormat || "")(value), "valueFormat");
    } else {
...
var getClasses = __name2(function(_text, diagramObj) {
...
//# sourceMappingURL=diagram-PSM6KHXK-P7EIQAPC.js.map
