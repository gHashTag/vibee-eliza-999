...
var getAxes = __name2(() => data.axes, "getAxes");
var getCurves = __name2(() => data.curves, "getCurves");
var getOptions = __name2(() => data.options, "getOptions");
var setAxes = __name2((axes) => {
...
var computeCurveEntries = __name2((entries) => {
...
var setOptions = __name2((options) => {
...
var draw = __name2((_text, id, _version, diagram2) => {
...
var drawFrame = __name2((svg, config) => {
...
var drawGraticule = __name2((g, axes, radius, ticks, graticule) => {
  if (graticule === "circle") {
...
var drawAxes = __name2((g, axes, radius, config) => {
  const numAxes = axes.length;
...
var renderer = { draw };
var genIndexStyles = __name2((themeVariables, radarOptions) => {
  let sections = "";
...
var buildRadarStyleOptions = __name2((radar) => {
...
//# sourceMappingURL=diagram-QEK2KX5R-3DJKTFGK.js.map
