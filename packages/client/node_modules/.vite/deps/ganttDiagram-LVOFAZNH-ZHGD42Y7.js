...
var setAxisFormat = __name2(function(txt) {
  axisFormat = txt;
}, "setAxisFormat");
var getAxisFormat = __name2(function() {
  return axisFormat;
}, "getAxisFormat");
var setTickInterval = __name2(function(txt) {
  tickInterval = txt;
}, "setTickInterval");
var getTickInterval = __name2(function() {
  return tickInterval;
}, "getTickInterval");
var setTodayMarker = __name2(function(txt) {
  todayMarker = txt;
}, "setTodayMarker");
var getTodayMarker = __name2(function() {
  return todayMarker;
}, "getTodayMarker");
var setDateFormat = __name2(function(txt) {
  dateFormat = txt;
}, "setDateFormat");
var enableInclusiveEndDates = __name2(function() {
  inclusiveEndDates = true;
}, "enableInclusiveEndDates");
var endDatesAreInclusive = __name2(function() {
  return inclusiveEndDates;
}, "endDatesAreInclusive");
var enableTopAxis = __name2(function() {
  topAxis = true;
}, "enableTopAxis");
var topAxisEnabled = __name2(function() {
  return topAxis;
}, "topAxisEnabled");
var setDisplayMode = __name2(function(txt) {
  displayMode = txt;
}, "setDisplayMode");
var getDisplayMode = __name2(function() {
  return displayMode;
}, "getDisplayMode");
var getDateFormat = __name2(function() {
  return dateFormat;
}, "getDateFormat");
var setIncludes = __name2(function(txt) {
  includes = txt.toLowerCase().split(/[\s,]+/);
}, "setIncludes");
var getIncludes = __name2(function() {
  return includes;
}, "getIncludes");
var setExcludes = __name2(function(txt) {
  excludes = txt.toLowerCase().split(/[\s,]+/);
}, "setExcludes");
var getExcludes = __name2(function() {
  return excludes;
}, "getExcludes");
var getLinks = __name2(function() {
  return links;
}, "getLinks");
var addSection = __name2(function(txt) {
  currentSection = txt;
  sections.push(txt);
}, "addSection");
var getSections = __name2(function() {
  return sections;
}, "getSections");
var getTasks = __name2(function() {
...
var isInvalidDate = __name2(function(date, dateFormat2, excludes2, includes2) {
...
var setWeekday = __name2(function(txt) {
  weekday = txt;
}, "setWeekday");
var getWeekday = __name2(function() {
  return weekday;
}, "getWeekday");
var setWeekend = __name2(function(startDay) {
  weekend = startDay;
}, "setWeekend");
var checkTaskDates = __name2(function(task, dateFormat2, excludes2, includes2) {
...
var fixTaskDates = __name2(function(startTime, endTime, dateFormat2, excludes2, includes2) {
  let invalid = false;
...
var getStartDate = __name2(function(prevTime, dateFormat2, str) {
  str = str.trim();
...
var parseDuration = __name2(function(str) {
...
var getEndDate = __name2(function(prevTime, dateFormat2, str, inclusive = false) {
  str = str.trim();
...
var taskCnt = 0;
var parseId = __name2(function(idStr) {
  if (idStr === void 0) {
    taskCnt = taskCnt + 1;
    return "task" + taskCnt;
  }
...
var compileData = __name2(function(prevTask, dataStr) {
  let ds;
...
var parseData = __name2(function(prevTaskId, dataStr) {
  let ds;
  if (dataStr.substr(0, 1) === ":") {
    ds = dataStr.substr(1, dataStr.length);
  } else {
...
var rawTasks = [];
var taskDb = {};
var addTask = __name2(function(descr, data) {
  const rawTask = {
...
var findTaskById = __name2(function(id) {
  const pos = taskDb[id];
  return rawTasks[pos];
}, "findTaskById");
var addTaskOrg = __name2(function(descr, data) {
  const newTask = {
    section: currentSection,
    type: currentSection,
    description: descr,
...
var compileTasks = __name2(function() {
  const compileTask = __name2(function(pos) {
...
var setLink = __name2(function(ids, _linkStr) {
...
var setClass = __name2(function(ids, className) {
  ids.split(",").forEach(function(id) {
    let rawTask = findTaskById(id);
    if (rawTask !== void 0) {
...
var setClickFun = __name2(function(id, functionName, functionArgs) {
  if (getConfig2().securityLevel !== "loose") {
    return;
  }
...
var pushFun = __name2(function(id, callbackFunction) {
  funs.push(
    function() {
...
var setClickEvent = __name2(function(ids, functionName, functionArgs) {
  ids.split(",").forEach(function(id) {
    setClickFun(id, functionName, functionArgs);
  });
  setClass(ids, "clickable");
}, "setClickEvent");
var bindFunctions = __name2(function(element) {
  funs.forEach(function(fun) {
    fun(element);
  });
}, "bindFunctions");
var ganttDb_default = {
  getConfig: __name2(() => getConfig2().gantt, "getConfig"),
  clear: clear2,
  setDateFormat,
  getDateFormat,
  enableInclusiveEndDates,
...
__name2(getTaskTags, "getTaskTags");
var setConf = __name2(function() {
...
var getMaxIntersections = __name2((tasks2, orderOffset) => {
...
var w;
var draw = __name2(function(text, id, version, diagObj) {
  ...
  __name2(taskCompare, "taskCompare");
  ...
  __name2(drawExcludeDays, "drawExcludeDays");
  ...
  __name2(checkUnique, "checkUnique");
}, "draw");
var ganttRenderer_default = {
  setConf,
  draw
};
var getStyles = __name2((options) => `
  .mermaid-main-font {
...
//# sourceMappingURL=ganttDiagram-LVOFAZNH-ZHGD42Y7.js.map
