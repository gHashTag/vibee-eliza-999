import {
  populateCommonDb
} from "./chunk-ZTY7DFUE.js";
import {
  ImperativeState
} from "./chunk-EQ4EFFED.js";
import {
  parse
} from "./chunk-R44A2QUA.js";
import "./chunk-WPPPIH4J.js";
import "./chunk-RV3PQNRK.js";
import "./chunk-52S2LQ4Z.js";
import "./chunk-H3WNS34C.js";
import "./chunk-SC4V3PKL.js";
import {
  cleanAndMerge,
  random,
  utils_default
...
import "./chunk-KYRL7MT7.js";
import "./chunk-WRUZTPNW.js";
import "./chunk-KK6H3XHX.js";
import "./chunk-5XX4YITM.js";
...
__name2(uniqBy, "uniqBy");
var setDirection = __name2(function(dir2) {
  state.records.direction = dir2;
}, "setDirection");
var setOptions = __name2(function(rawOptString) {
...
var getOptions = __name2(function() {
  return state.records.options;
}, "getOptions");
var commit = __name2(function(commitDB) {
...
var branch = __name2(function(branchDB) {
...
var cherryPick = __name2(function(cherryPickDB) {
...
var checkout = __name2(function(branch2) {
...
__name2(prettyPrintCommitHistory, "prettyPrintCommitHistory");
var prettyPrint = __name2(function() {
...
var getBranchesAsObjArray = __name2(function() {
...
var getBranches = __name2(function() {
  return state.records.branches;
}, "getBranches");
var getCommits = __name2(function() {
  return state.records.commits;
}, "getCommits");
var getCommitsArray = __name2(function() {
...
var getCurrentBranch = __name2(function() {
  return state.records.currBranch;
}, "getCurrentBranch");
var getDirection = __name2(function() {
  return state.records.direction;
}, "getDirection");
var getHead = __name2(function() {
...
var parseStatement = __name2((statement, db2) => {
  const parsers = {
    Commit: __name2((stmt) => db2.commit(parseCommit(stmt)), "Commit"),
    Branch: __name2((stmt) => db2.branch(parseBranch(stmt)), "Branch"),
    Merge: __name2((stmt) => db2.merge(parseMerge(stmt)), "Merge"),
    Checkout: __name2((stmt) => db2.checkout(parseCheckout(stmt)), "Checkout"),
    CherryPicking: __name2((stmt) => db2.cherryPick(parseCherryPicking(stmt)), "CherryPicking")
  };
...
var parseCommit = __name2((commit2) => {
  const commitDB = {
    id: commit2.id,
    msg: commit2.message ?? "",
...
var parseBranch = __name2((branch2) => {
  const branchDB = {
    name: branch2.name,
...
var parseCheckout = __name2((checkout2) => {
  const branch2 = checkout2.branch;
  return branch2;
}, "parseCheckout");
var parseCherryPicking = __name2((cherryPicking) => {
  const cherryPickDB = {
    id: cherryPicking.id,
    targetId: "",
...
var findClosestParent = __name2((parents) => {
  let closestParent;
  let comparisonFunc;
  let targetPosition;
  if (dir === "BT") {
    comparisonFunc = __name2((a, b) => a <= b, "comparisonFunc");
...
var findClosestParentBT = __name2((parents) => {
  let closestParent = "";
...
var setParallelBTPos = __name2((sortedKeys, commits, defaultPos2) => {
...
var findClosestParentPos = __name2((commit2) => {
...
var calculateCommitPosition = __name2((commit2) => {
  const closestParentPos = findClosestParentPos(commit2);
  return closestParentPos + COMMIT_STEP;
}, "calculateCommitPosition");
var setCommitPosition = __name2((commit2, curPos) => {
...
var setRootPosition = __name2((commit2, curPos, defaultPos2) => {
  const branch2 = branchPos.get(commit2.branch);
  if (!branch2) {
    throw new Error(`Branch not found for commit ${commit2.id}`);
  }
...
var drawCommitBullet = __name2((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
...
var drawCommitLabel = __name2((gLabels, commit2, commitPosition, pos) => {
...
var drawCommitTags = __name2((gLabels, commit2, commitPosition, pos) => {
...
var getCommitClassType = __name2((commit2) => {
...
var calculatePosition = __name2((commit2, dir2, pos, commitPos2) => {
...
var getCommitPosition = __name2((commit2, pos, isParallelCommits) => {
...
var drawCommits = __name2((svg, commits, modifyGraph) => {
...
var shouldRerouteArrow = __name2((commitA, commitB, p1, p2, allCommits) => {
  const commitBIsFurthest = dir === "TB" || dir === "BT" ? p1.x < p2.x : p1.y < p2.y;
  const branchToGetCurve = commitBIsFurthest ? commitB.branch : commitA.branch;
  const isOnBranchToGetCurve = __name2((x) => x.branch === branchToGetCurve, "isOnBranchToGetCurve");
  const isBetweenCommits = __name2((x) => x.seq > commitA.seq && x.seq < commitB.seq, "isBetweenCommits");
  return [...allCommits.values()].some((commitX) => {
    return isBetweenCommits(commitX) && isOnBranchToGetCurve(commitX);
  });
}, "shouldRerouteArrow");
var findLane = __name2((y1, y2, depth = 0) => {
...
var drawArrow = __name2((svg, commitA, commitB, allCommits) => {
...
var drawArrows = __name2((svg, commits) => {
...
var drawBranches = __name2((svg, branches) => {
...
var setBranchPosition = __name2(function(name, pos, index, bbox, rotateCommitLabel) {
  branchPos.set(name, { pos, index });
  pos += 50 + (rotateCommitLabel ? 40 : 0) + (dir === "TB" || dir === "BT" ? bbox.width / 2 : 0);
  return pos;
}, "setBranchPosition");
var draw = __name2(function(txt, id, ver, diagObj) {
  clear3();
...
//# sourceMappingURL=gitGraphDiagram-NY62KEGX-WVX6QA7O.js.map
