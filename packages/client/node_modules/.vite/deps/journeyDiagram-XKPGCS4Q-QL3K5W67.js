...
var updateActors = __name2(function() {
  const tempActors = [];
  tasks.forEach((task) => {
    if (task.people) {
...
var addTask = __name2(function(descr, taskData) {
...
var getActors = __name2(function() {
  return updateActors();
}, "getActors");
var journeyDb_default = {
  getConfig: __name2(() => getConfig2().journey, "getConfig"),
  clear: clear2,
  setDiagramTitle,
  getDiagramTitle,
  setAccTitle,
...
var drawText2 = __name2(function(elem, textData) {
...
var drawSection = __name2(function(elem, section, conf2) {
...
var taskCount = -1;
var drawTask = __name2(function(elem, task, conf2) {
...
__name2(drawActorLegend, "drawActorLegend");
...
var drawTasks = __name2(function(diagram2, tasks2, verticalPos) {
  const conf2 = getConfig2().journey;
  let lastSection = "";
...
//# sourceMappingURL=journeyDiagram-XKPGCS4Q-QL3K5W67.js.map
