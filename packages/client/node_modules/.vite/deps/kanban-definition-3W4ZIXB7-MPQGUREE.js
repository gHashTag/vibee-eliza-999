...
import {
  ...
  insertNode,
  positionNode
} from "./chunk-OXJQOY5E.js";
import "./chunk-CIUECYE5.js";
import "./chunk-WGZFG6CT.js";
import "./chunk-MAYWSMMN.js";
import "./chunk-ZP53DU5B.js";
...
var addNode = __name2((level, id, descr, type, shapeData) => {
  const conf = getConfig2();
...
var getType = __name2((startStr, endStr) => {
...
var setElementForId = __name2((id, element) => {
  elements[id] = element;
}, "setElementForId");
var decorateNode = __name2((decoration) => {
  if (!decoration) {
    return;
  }
...
var getElementById = __name2((id) => elements[id], "getElementById");
var db = {
  clear,
  addNode,
  getSections,
...
var genSections = __name2((options) => {
  ...
  const adjuster = __name2((color, level) => options.darkMode ? darken_default(color, level) : lighten_default(color, level), "adjuster");
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    const sw = "" + (17 - 3 * i);
    sections2 += `
...
//# sourceMappingURL=kanban-definition-3W4ZIXB7-MPQGUREE.js.map
