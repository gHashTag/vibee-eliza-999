...
__name(uint8ToUint32, "uint8ToUint32");
...
var parser = (function() {
  ...
  var parser2 = {
    ...
    parse: __name2(/* @__PURE__ */ __name(function parse2(input) {
...
var MindmapDB = (_a = class {
  ...
  flattenNodes(node, processedNodes) {
    ...
    const getShapeFromType = __name2((type) => {
      switch (type) {
...
}, __name(_a, "MindmapDB"), __name2(_a, "MindmapDB"), _a);
...
//# sourceMappingURL=mindmap-definition-VGOIOE7T-TNBGVH3B.js.map
