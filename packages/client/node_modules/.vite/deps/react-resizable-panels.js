...
function PanelWithForwardedRef({
  ...
  (0, import_react.useImperativeHandle)(forwardedRef, () => ({
    ...
    expand: /* @__PURE__ */ __name((minSize2) => {
...
__name(PanelWithForwardedRef, "PanelWithForwardedRef");
...
__name(customizeGlobalCursorStyles, "customizeGlobalCursorStyles");
function disableGlobalCursorStyles() {
  enabled = false;
}
__name(disableGlobalCursorStyles, "disableGlobalCursorStyles");
function enableGlobalCursorStyles() {
  enabled = true;
}
__name(enableGlobalCursorStyles, "enableGlobalCursorStyles");
...
__name(getCursorStyle, "getCursorStyle");
...
__name(resetGlobalCursorStyle, "resetGlobalCursorStyle");
...
__name(setGlobalCursorStyle, "setGlobalCursorStyle");
function isKeyDown(event) {
  return event.type === "keydown";
}
__name(isKeyDown, "isKeyDown");
...
__name(getResizeEventCoordinates, "getResizeEventCoordinates");
...
__name(is_flex_item, "is_flex_item");
...
__name(creates_stacking_context, "creates_stacking_context");
...
__name(find_stacking_context, "find_stacking_context");
function get_z_index(node) {
  return node && Number(getComputedStyle(node).zIndex) || 0;
}
__name(get_z_index, "get_z_index");
...
__name(get_ancestors, "get_ancestors");
...
function registerResizeHandle(resizeHandleId, element, direction, hitAreaMargins, setResizeHandlerState) {
  ...
  updateListeners();
  return /* @__PURE__ */ __name(function unregisterResizeHandle() {
...
__name(registerResizeHandle, "registerResizeHandle");
...
__name(isWithinResizeHandle, "isWithinResizeHandle");
...
__name(recalculateIntersectingHandles, "recalculateIntersectingHandles");
function reportConstraintsViolation(resizeHandleId, flag) {
  panelConstraintFlags.set(resizeHandleId, flag);
}
__name(reportConstraintsViolation, "reportConstraintsViolation");
...
__name(updateCursor, "updateCursor");
...
__name(updateResizeHandlerStates, "updateResizeHandlerStates");
...
__name(fuzzyCompareNumbers, "fuzzyCompareNumbers");
function fuzzyNumbersEqual$1(actual, expected, fractionDigits = PRECISION) {
  return fuzzyCompareNumbers(actual, expected, fractionDigits) === 0;
}
__name(fuzzyNumbersEqual$1, "fuzzyNumbersEqual$1");
function fuzzyNumbersEqual(actual, expected, fractionDigits) {
  return fuzzyCompareNumbers(actual, expected, fractionDigits) === 0;
}
__name(fuzzyNumbersEqual, "fuzzyNumbersEqual");
...
__name(fuzzyLayoutsEqual, "fuzzyLayoutsEqual");
...
__name(resizePanel, "resizePanel");
...
__name(adjustLayoutByDelta, "adjustLayoutByDelta");
...
__name(calculateAriaValues, "calculateAriaValues");
function getResizeHandleElementsForGroup(groupId, scope = document) {
  return Array.from(scope.querySelectorAll(`[${DATA_ATTRIBUTES.resizeHandleId}][data-panel-group-id="${groupId}"]`));
}
__name(getResizeHandleElementsForGroup, "getResizeHandleElementsForGroup");
function getResizeHandleElementIndex(groupId, id, scope = document) {
  const handles = getResizeHandleElementsForGroup(groupId, scope);
  const index = handles.findIndex((handle) => handle.getAttribute(DATA_ATTRIBUTES.resizeHandleId) === id);
  return index !== null && index !== void 0 ? index : null;
}
__name(getResizeHandleElementIndex, "getResizeHandleElementIndex");
function determinePivotIndices(groupId, dragHandleId, panelGroupElement) {
  const index = getResizeHandleElementIndex(groupId, dragHandleId, panelGroupElement);
  return index != null ? [index, index + 1] : [-1, -1];
}
__name(determinePivotIndices, "determinePivotIndices");
...
__name(getPanelGroupElement, "getPanelGroupElement");
...
__name(getResizeHandleElement, "getResizeHandleElement");
...
__name(getResizeHandlePanelIds, "getResizeHandlePanelIds");
...
__name(useWindowSplitterPanelGroupBehavior, "useWindowSplitterPanelGroupBehavior");
...
__name(getResizeEventCursorPosition, "getResizeEventCursorPosition");
...
__name(calculateDragOffsetPercentage, "calculateDragOffsetPercentage");
...
__name(calculateDeltaPercentage, "calculateDeltaPercentage");
...
__name(calculateUnsafeDefaultLayout, "calculateUnsafeDefaultLayout");
...
__name(callPanelCallbacks, "callPanelCallbacks");
...
__name(compareLayouts, "compareLayouts");
...
__name(computePanelFlexBoxStyle, "computePanelFlexBoxStyle");
function debounce(callback, durationMs = 10) {
  let timeoutId = null;
  let callable = /* @__PURE__ */ __name((...args) => {
    if (timeoutId !== null) {
...
__name(initializeDefaultStorage, "initializeDefaultStorage");
function getPanelGroupKey(autoSaveId) {
  return `react-resizable-panels:${autoSaveId}`;
}
__name(getPanelGroupKey, "getPanelGroupKey");
...
__name(getPanelKey, "getPanelKey");
...
__name(loadSerializedPanelGroupState, "loadSerializedPanelGroupState");
...
__name(loadPanelGroupState, "loadPanelGroupState");
...
__name(savePanelGroupState, "savePanelGroupState");
...
__name(validatePanelConstraints, "validatePanelConstraints");
...
__name(validatePanelGroupLayout, "validatePanelGroupLayout");
...
var defaultStorage = {
  ...
  setItem: /* @__PURE__ */ __name((name, value) => {
    initializeDefaultStorage(defaultStorage);
...
function PanelGroupWithForwardedRef({
  ...
  (0, import_react.useImperativeHandle)(forwardedRef, () => ({
    getId: /* @__PURE__ */ __name(() => committedValuesRef.current.id, "getId"),
    getLayout: /* @__PURE__ */ __name(() => {
      const {
        layout: layout2
      } = eagerValuesRef.current;
      return layout2;
    }, "getLayout"),
    setLayout: /* @__PURE__ */ __name((unsafeLayout) => {
      const {
        onLayout: onLayout2
  ...
  const registerResizeHandle2 = (0, import_react.useCallback)((dragHandleId) => {
    ...
    return /* @__PURE__ */ __name(function resizeHandler(event) {
      event.preventDefault();
...
__name(PanelGroupWithForwardedRef, "PanelGroupWithForwardedRef");
...
__name(findPanelDataIndex, "findPanelDataIndex");
...
__name(panelDataHelper, "panelDataHelper");
...
__name(useWindowSplitterResizeHandlerBehavior, "useWindowSplitterResizeHandlerBehavior");
function PanelResizeHandle({
  ...
  (0, import_react.useEffect)(() => {
    ...
    let didMove = false;
    const setResizeHandlerState = /* @__PURE__ */ __name((action, isActive, event) => {
      if (!isActive) {
        setState("inactive");
        return;
      }
...
__name(PanelResizeHandle, "PanelResizeHandle");
...
__name(usePanelGroupContext, "usePanelGroupContext");
...
__name(getPanelElement, "getPanelElement");
function getPanelElementsForGroup(groupId, scope = document) {
  return Array.from(scope.querySelectorAll(`[data-panel][data-panel-group-id="${groupId}"]`));
}
__name(getPanelElementsForGroup, "getPanelElementsForGroup");
...
__name(getIntersectingRectangle, "getIntersectingRectangle");
export {
  DATA_ATTRIBUTES,
  Panel,
  PanelGroup,
