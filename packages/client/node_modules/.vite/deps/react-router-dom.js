...
__name(initSsrInfo, "initSsrInfo");
function createHydratedRouter({
  ...
  if (ssrInfo.context.isSpaMode) {
    ...
    hydrationData = getHydrationData({
      ...
      routes,
      getRouteInfo: /* @__PURE__ */ __name((routeId) => ({
...
__name(createHydratedRouter, "createHydratedRouter");
...
__name(HydratedRouter, "HydratedRouter");
