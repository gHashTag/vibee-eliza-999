...
__name(ascendingComparator, "ascendingComparator");
...
function shuffler(random) {
  return /* @__PURE__ */ __name(function shuffle(array2, i0 = 0, i1 = array2.length) {
    let m = i1 - (i0 = +i0);
    while (m) {
...
var parser = (function() {
  var o = __name2(function(k2, v, o2, l) {
...
}, __name(_a, "SankeyLink"), __name2(_a, "SankeyLink"), _a);
var addLink = __name2((source, target, value2) => {
...
}, __name(_a2, "SankeyNode"), __name2(_a2, "SankeyNode"), _a2);
var findOrCreateNode = __name2((ID) => {
...
var getNodes = __name2(() => nodes, "getNodes");
var getLinks = __name2(() => links, "getLinks");
var getGraph = __name2(() => ({
...
var sankeyDB_default = {
  nodesMap,
  getConfig: __name2(() => getConfig2().sankey, "getConfig"),
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
}, __name(_a3, "_Uid"), __name2(_a3, "Uid"), _a3.count = 0, _a3);
var alignmentsMap = {
  left,
  right,
  center,
...
var draw = __name2(function(text, id, _version, diagObj) {
  ...
  const getText = __name2(({ id: id2, value: value2 }) => {
    if (!showValues) {
      return id2;
    }
    return `${id2}
${prefix}${Math.round(value2 * 100) / 100}${suffix}`;
  ...
  switch (linkColor) {
    case "gradient":
      coloring = __name2((d) => d.uid, "coloring");
      break;
    case "source":
      coloring = __name2((d) => colorScheme(d.source.id), "coloring");
      break;
    case "target":
      coloring = __name2((d) => colorScheme(d.target.id), "coloring");
      break;
    default:
      coloring = linkColor;
  }
...
var prepareTextForParsing = __name2((text) => {
...
//# sourceMappingURL=sankeyDiagram-TZEHDZUN-NIQ352T3.js.map
