...
import {
  ...
  getNoteRect,
  getTextObj
} from "./chunk-PRXKXUGD.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-MTAGYPZT.js";
import {
  ZERO_WIDTH_SPACE,
  parseFontSize,
  utils_default
} from "./chunk-ZP53DU5B.js";
import {
  require_dist
} from "./chunk-CCCBBD7J.js";
import {
  ...
  setConfig2,
  setDiagramTitle
} from "./chunk-6E4Q22DB.js";
import {
  __name as __name2,
  log,
  select_default
} from "./chunk-57HICAL6.js";
import "./chunk-THEGQYF3.js";
import "./chunk-GYNIGSSE.js";
import {
  __name,
  __toESM
...
var parser = (function() {
  var o = __name2(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: __name2(/* @__PURE__ */ __name(function trace() {
    }, "trace"), "trace"),
    yy: {},
    ...
    performAction: __name2(/* @__PURE__ */ __name(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 3:
          yy.apply($$[$0]);
    ...
    parseError: __name2(/* @__PURE__ */ __name(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: __name2(/* @__PURE__ */ __name(function parse(input) {
  ...
  var lexer = (function() {
    var lexer2 = {
      ...
      setInput: __name2(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      more: __name2(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: __name2(function() {
      ...
      less: __name2(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: __name2(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: __name2(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: __name2(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: __name2(function(match, indexed_rule) {
      ...
      lex: __name2(/* @__PURE__ */ __name(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: __name2(/* @__PURE__ */ __name(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"), "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: __name2(/* @__PURE__ */ __name(function popState() {
      ...
      _currentRules: __name2(/* @__PURE__ */ __name(function _currentRules() {
      ...
      topState: __name2(/* @__PURE__ */ __name(function topState(n) {
      ...
      pushState: __name2(/* @__PURE__ */ __name(function pushState(condition) {
        this.begin(condition);
      }, "pushState"), "pushState"),
      // return the number of states currently on the stack
      stateStackSize: __name2(/* @__PURE__ */ __name(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"), "stateStackSize"),
      options: { "case-insensitive": true },
      performAction: __name2(/* @__PURE__ */ __name(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
...
}, __name(_a, "SequenceDB"), __name2(_a, "SequenceDB"), _a);
var getStyles = __name2((options) => `.actor {
...
var drawRect2 = __name2(function(elem, rectData) {
  return drawRect(elem, rectData);
}, "drawRect");
var drawPopup = __name2(function(elem, actor, minMenuWidth, textAttrs, forceMenus) {
...
var popupMenuToggle = __name2(function(popId) {
  return "var pu = document.getElementById('" + popId + "'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }";
}, "popupMenuToggle");
var drawKatex = __name2(async function(elem, textData, msgModel = null) {
...
var drawText = __name2(function(elem, textData) {
  ...
  let textElems = [];
  let dy = 0;
  let yfunc = __name2(() => textData.y, "yfunc");
  if (textData.valign !== void 0 && textData.textMargin !== void 0 && textData.textMargin > 0) {
    switch (textData.valign) {
      case "top":
      case "start":
        yfunc = __name2(() => Math.round(textData.y + textData.textMargin), "yfunc");
        break;
      case "middle":
      case "center":
        yfunc = __name2(() => Math.round(textData.y + (prevTextHeight + textHeight + textData.textMargin) / 2), "yfunc");
        break;
      case "bottom":
      case "end":
        yfunc = __name2(() => Math.round(
...
var drawLabel = __name2(function(elem, txtObject) {
  function genPoints(x, y, width, height, cut) {
    return x + "," + y + " " + (x + width) + "," + y + " " + (x + width) + "," + (y + height - cut) + " " + (x + width - cut * 1.2) + "," + (y + height) + " " + x + "," + (y + height);
  }
  __name(genPoints, "genPoints");
  __name2(genPoints, "genPoints");
...
var actorCnt = -1;
var fixLifeLineHeights = __name2((diagram2, actors, actorKeys, conf2) => {
  if (!diagram2.select) {
    return;
  }
...
var drawActorTypeParticipant = __name2(function(elem, actor, conf2, isFooter) {
...
var drawActorTypeCollections = __name2(function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
  const boxplusLineGroup = elem.append("g").lower();
...
var drawActorTypeQueue = __name2(function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
  const boxplusLineGroup = elem.append("g").lower();
...
var drawActorTypeControl = __name2(function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeEntity = __name2(function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 75;
  const line = elem.append("g").lower();
...
var drawActorTypeDatabase = __name2(function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeBoundary = __name2(function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeActor = __name2(function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 80;
  const line = elem.append("g").lower();
...
var drawActor = __name2(async function(elem, actor, conf2, isFooter) {
  switch (actor.type) {
    case "actor":
...
var drawBox = __name2(function(elem, box, conf2) {
...
var anchorElement = __name2(function(elem) {
  return elem.append("g");
}, "anchorElement");
var drawActivation = __name2(function(elem, bounds2, verticalPos, conf2, actorActivations2) {
  const rect = getNoteRect();
...
var drawLoop = __name2(async function(elem, loopModel, labelText, conf2) {
  const {
    boxMargin,
    boxTextMargin,
    labelBoxHeight,
  ...
  const g = elem.append("g");
  const drawLoopLine = __name2(function(startx, starty, stopx, stopy) {
...
var drawBackgroundRect2 = __name2(function(elem, bounds2) {
  drawBackgroundRect(elem, bounds2);
}, "drawBackgroundRect");
var insertDatabaseIcon = __name2(function(elem) {
...
var insertArrowFilledHead = __name2(function(elem) {
...
var insertSequenceNumber = __name2(function(elem) {
  elem.append("defs").append("marker").attr("id", "sequencenumber").attr("refX", 15).attr("refY", 15).attr("markerWidth", 60).attr("markerHeight", 40).attr("orient", "auto").append("circle").attr("cx", 15).attr("cy", 15).attr("r", 6);
}, "insertSequenceNumber");
var insertArrowCrossHead = __name2(function(elem) {
...
var getTextObj2 = __name2(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
var getNoteRect2 = __name2(function() {
  return {
    x: 0,
    y: 0,
    fill: "#EDF2AE",
...
var _drawTextCandidateFunc = (function() {
  ...
  __name2(_setTextAttrs, "_setTextAttrs");
...
var bounds = {
  ...
  models: {
    ...
    addBox: __name2(function(boxModel) {
      this.boxes.push(boxModel);
    }, "addBox"),
    addActor: __name2(function(actorModel) {
      this.actors.push(actorModel);
    }, "addActor"),
    addLoop: __name2(function(loopModel) {
      this.loops.push(loopModel);
    }, "addLoop"),
    addMessage: __name2(function(msgModel) {
      this.messages.push(msgModel);
    }, "addMessage"),
    addNote: __name2(function(noteModel) {
      this.notes.push(noteModel);
    }, "addNote"),
    lastActor: __name2(function() {
      return this.actors[this.actors.length - 1];
    }, "lastActor"),
    lastLoop: __name2(function() {
      return this.loops[this.loops.length - 1];
    }, "lastLoop"),
    lastMessage: __name2(function() {
      return this.messages[this.messages.length - 1];
    }, "lastMessage"),
    lastNote: __name2(function() {
  ...
  updateVal: __name2(function(obj, key, val, fun) {
    if (obj[key] === void 0) {
      obj[key] = val;
    } else {
  ...
  updateBounds: __name2(function(startx, starty, stopx, stopy) {
    const _self = this;
    let cnt = 0;
    function updateFn(type) {
      return __name2(/* @__PURE__ */ __name(function updateItemBounds(item) {
        cnt++;
      ...
      }, "updateItemBounds"), "updateItemBounds");
    }
    __name(updateFn, "updateFn");
    __name2(updateFn, "updateFn");
    this.sequenceItems.forEach(updateFn());
    this.activations.forEach(updateFn("activation"));
  }, "updateBounds"),
  insert: __name2(function(startx, starty, stopx, stopy) {
  ...
  newActivation: __name2(function(message, diagram2, actors) {
  ...
  endActivation: __name2(function(message) {
    const lastActorActivationIdx = this.activations.map(function(activation) {
      return activation.actor;
    }).lastIndexOf(message.from);
    return this.activations.splice(lastActorActivationIdx, 1)[0];
  }, "endActivation"),
  createLoop: __name2(function(title = { message: void 0, wrap: false, width: void 0 }, fill) {
    return {
      startx: void 0,
  ...
  newLoop: __name2(function(title = { message: void 0, wrap: false, width: void 0 }, fill) {
    this.sequenceItems.push(this.createLoop(title, fill));
  }, "newLoop"),
  endLoop: __name2(function() {
    return this.sequenceItems.pop();
  }, "endLoop"),
  isLoopOverlap: __name2(function() {
    return this.sequenceItems.length ? this.sequenceItems[this.sequenceItems.length - 1].overlap : false;
  }, "isLoopOverlap"),
  addSectionToLoop: __name2(function(message) {
  ...
  saveVerticalPos: __name2(function() {
    if (this.isLoopOverlap()) {
      this.savedVerticalPos = this.verticalPos;
    }
  }, "saveVerticalPos"),
  resetVerticalPos: __name2(function() {
    if (this.isLoopOverlap()) {
      this.verticalPos = this.savedVerticalPos;
    }
  }, "resetVerticalPos"),
  bumpVerticalPos: __name2(function(bump) {
    this.verticalPos = this.verticalPos + bump;
    this.data.stopy = common_default.getMax(this.data.stopy, this.verticalPos);
  }, "bumpVerticalPos"),
  getVerticalPos: __name2(function() {
    return this.verticalPos;
  }, "getVerticalPos"),
  getBounds: __name2(function() {
    return { bounds: this.data, models: this.models };
  }, "getBounds")
};
var drawNote = __name2(async function(elem, noteModel) {
...
__name2(boundMessage, "boundMessage");
var drawMessage = __name2(async function(diagram2, msgModel, lineStartY, diagObj) {
...
var addActorRenderingData = __name2(function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  let prevWidth = 0;
  let prevMargin = 0;
  let prevBox = void 0;
  let maxHeight = 0;
...
var drawActors = __name2(async function(diagram2, actors, actorKeys, isFooter) {
  if (!isFooter) {
    for (const actorKey of actorKeys) {
      const actor = actors.get(actorKey);
...
var drawActorsPopup = __name2(function(diagram2, actors, actorKeys, doc) {
  let maxHeight = 0;
  let maxWidth = 0;
  for (const actorKey of actorKeys) {
    const actor = actors.get(actorKey);
...
var setConf = __name2(function(cnf) {
...
var actorActivations = __name2(function(actor) {
  return bounds.activations.filter(function(activation) {
    return activation.actor === actor;
  });
}, "actorActivations");
var activationBounds = __name2(function(actor, actors) {
...
__name2(adjustLoopHeightForWrap, "adjustLoopHeightForWrap");
function adjustCreatedDestroyedData(msg, msgModel, lineStartY, index, actors, createdActors, destroyedActors) {
  ...
  __name2(receiverAdjustment, "receiverAdjustment");
  ...
  __name2(senderAdjustment, "senderAdjustment");
  const actorArray = [
...
__name2(adjustCreatedDestroyedData, "adjustCreatedDestroyedData");
var draw = __name2(async function(_text, id, _version, diagObj) {
...
__name2(getMaxMessageWidthPerActor, "getMaxMessageWidthPerActor");
var getRequiredPopupWidth = __name2(function(actor) {
...
__name2(calculateActorMargins, "calculateActorMargins");
var buildNoteModel = __name2(async function(msg, actors, diagObj) {
...
var buildMessageModel = __name2(function(msg, actors, diagObj) {
  if (![
    diagObj.db.LINETYPE.SOLID_OPEN,
    diagObj.db.LINETYPE.DOTTED_OPEN,
    diagObj.db.LINETYPE.SOLID,
  ...
  const adjustValue = __name2((value) => {
...
var calculateLoopBounds = __name2(async function(messages, actors, _maxWidthPerActor, diagObj) {
  const loops = {};
  const stack = [];
...
//# sourceMappingURL=sequenceDiagram-WL72ISMW-IDTIDCTH.js.map
