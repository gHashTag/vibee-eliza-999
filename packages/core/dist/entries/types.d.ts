 ...
 */
import type { IAgentRuntime, Character, UUID, Content, ActionResult, Service, Plugin } from '../types';
...
export type AIServiceType = 'language' | 'vision' | 'audio' | 'multimodal' | 'embedding' | 'reranking' | 'moderation' | 'function';
export type AIPluginType = 'enhancement' | 'integration' | 'capability' | 'connector' | 'middleware';
...
export type AgentPhase = 'initialization' | 'decomposition' | 'delegation' | 'execution' | 'coordination' | 'synthesis' | 'verification' | 'completed' | 'failed';
