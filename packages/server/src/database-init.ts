    ...
    try {
        ...
        try {
            ...
            const checkResult = await pool.query(
                'SELECT id FROM message_servers WHERE id = $1',
                [DEFAULT_SERVER_ID]
            );
            ...
            if (checkResult.rows.length === 0) {
                ...
                await pool.query(
                    'INSERT INTO message_servers (id, name, source_type, source_id, metadata, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, NOW(), NOW())',
                    [
                        DEFAULT_SERVER_ID,
                        'Default Server',
                        'local',
