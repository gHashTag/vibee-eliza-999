...
export const character: Character = {
  ...
  plugins: [
    ...
    ...(process.env.ANTHROPIC_API_KEY?.trim()
      ...
      : []),
    // OpenRouter plugin - always load (API key loaded from Infisical)
    ...
    // Knowledge plugin for document-based learning (отключен - нет OpenAI ключа)
    // ...(process.env.OPENAI_API_KEY?.trim() ? ["@elizaos/plugin-knowledge"] : []),
