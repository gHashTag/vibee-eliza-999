...
async function generateAvatar(seed, style) {
  // Импортируем модуль DiceBear правильно с использованием ES-модулей
  const dicebear = await import('@dicebear/avatars');
  const { Avatars, AvataaarsSprites, HumanSprites, InitialsSprites } = dicebear;
