...
fn decode_dialog_json() -> Decoder(TelegramDialog) {
  ...
  use dtype <- decode.field("type", decode.optional(decode.string))
  ...
  use verified <- decode.field("is_verified", decode.optional(decode.bool))
  use restricted <- decode.field("is_restricted", decode.optional(decode.bool))
  use last_msg <- decode.field("last_message_id", decode.optional(decode.int))
  use last_parsed <- decode.field(
    "last_parsed_at",
    decode.optional(decode.string),
  )
  use total <- decode.field("total_messages", decode.optional(decode.int))
  use parsed <- decode.field("parsed_messages", decode.optional(decode.int))
